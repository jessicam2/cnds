...
module Global {   
    export class WorkflowActivityViewModel {
        ...
        private GetResultID(ctl: JQuery) : string {
    ...
    interface IKendoDataSourceSettings {
        page: number;
        pageSize: number;
    ...
    interface IKendoGridSettings extends IKendoDataSourceSettings{
    ...
    export class Helpers {
        ...
        static GetFiltersFromUrl(): kendo.data.DataSourceFilterItem[] {
            var filter = <any> Global.GetQueryParam("filter");
            if (filter) {
                if (!$.isArray(filter))
        ...
        static GetSortsFromUrl(): kendo.data.DataSourceSortItem[] {
            var sort = <any>Global.GetQueryParam("sort");
            if (sort) {
    ...
    export function ShowTerms(params?) {
        ...
        Helpers.ShowDialog("Terms And Conditions", "/home/termsandconditions", ["close"], 800, 600, param).done(() => { });
    ...
    export function ShowInfo(params?) {
        ...
        Helpers.ShowDialog("Information", "/home/info", ["close"], 800, 600, param).done(() => { });
    }
...
module Constants {
    ...
    export var DateFormat = "MM/d/yyyy";
    export var DateFormatter = "{0:MM/d/yyyy}";
    export var DateTimeFormat = "MM/d/yyyy h:mm tt";
    export var DateTimeFormatter = "{0:MM/d/yyyy h:mm tt}";
    export var LineBreak = "<br/><br/>";
...
if ((typeof Dns != 'undefined') && Dns.WebApi != null)
    Dns.WebApi.Helpers.RegisterFailMethod((error) => {        
