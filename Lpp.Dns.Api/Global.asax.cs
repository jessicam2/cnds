...
#pragma warning disable 1591
    ...
    {
        /// <summary>
        /// The ID of the network for the instance.
        /// </summary>
        public static Guid NetworkID = Guid.Empty;
        ...
        protected void Application_Start()
        {
            ...
            using (var db = new DataContext())
            {
                ...
                NetworkID = db.Networks.Where(n => n.Name != "Aqueduct").Select(n => n.ID).FirstOrDefault();
            }
