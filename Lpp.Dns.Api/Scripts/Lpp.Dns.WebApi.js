...
(function (Dns) {
    ...
    (function (WebApi) {
        ...
        var Users = (function () {
            ...
            Users.GetAvailableUserMetadata = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('Users/GetAvailableUserMetadata' + params, doNotHandleFail);
            };
            ...
            Users.UpdateUserVisibility = function (userMetadata, doNotHandleFail) {
                return Helpers.PostAPIValue('Users/UpdateUserVisibility', userMetadata, doNotHandleFail);
            };
        ...
        var Theme = (function () {
            ...
            Theme.GetText = function (themeID, keys, doNotHandleFail) {
                var params = '';
                if (themeID != null)
                    params += '&themeID=' + encodeURIComponent(themeID);
                if (keys != null)
            ...
            Theme.GetImagePath = function (themeID, doNotHandleFail) {
                var params = '';
                if (themeID != null)
                    params += '&themeID=' + encodeURIComponent(themeID);
                if (params.length > 0)
        ...
        var Organizations = (function () {
            ...
            Organizations.GetAvailableOrganizationMetadata = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('Organizations/GetAvailableOrganizationMetadata' + params, doNotHandleFail);
            };
            ...
            Organizations.GetForUser = function (userID, $filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if (userID != null)
                    params += '&userID=' + userID;
                if ($filter)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('Organizations/GetForUser' + params, doNotHandleFail);
            };
            ...
            Organizations.UpdateOrganizationVisibility = function (orgMetadata, doNotHandleFail) {
                return Helpers.PostAPIValue('Organizations/UpdateOrganizationVisibility', orgMetadata, doNotHandleFail);
            };
        ...
        var DataMarts = (function () {
            ...
            DataMarts.GetAvailableDataMartMetadata = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('DataMarts/GetAvailableDataMartMetadata' + params, doNotHandleFail);
            };
            ...
            DataMarts.UpdateDataMartVisibility = function (dmMetadata, doNotHandleFail) {
                return Helpers.PostAPIValue('DataMarts/UpdateDataMartVisibility', dmMetadata, doNotHandleFail);
            };
        ...
        var Requests = (function () {
            ...
            Requests.CreateRequest = function (details, doNotHandleFail) {
                return Helpers.PostAPIValue('Requests/CreateRequest', details, doNotHandleFail);
            };
            ...
            Requests.GetExternalRoutesForRequest = function (requestID, $filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if (requestID != null)
                    params += '&requestID=' + requestID;
                if ($filter)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('Requests/GetExternalRoutesForRequest' + params, doNotHandleFail);
            };
        ...
        var Documents = (function () {
            ...
            Documents.UploadResponseOutput = function (doNotHandleFail) {
                return Helpers.PostAPIValue('Documents/UploadResponseOutput', doNotHandleFail);
            };
        ...
        var CNDSMetadata = (function () {
            function CNDSMetadata() {
            }
            CNDSMetadata.ListDomains = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSMetadata/ListDomains' + params, doNotHandleFail);
            };
            CNDSMetadata.InsertOrUpdateDomains = function (metaData, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSMetadata/InsertOrUpdateDomains', metaData, doNotHandleFail);
            };
            CNDSMetadata.GetForOrganization = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSMetadata/GetForOrganization' + params, doNotHandleFail);
            };
            CNDSMetadata.InsertorUpdateDataDomains = function (domainUses, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSMetadata/InsertorUpdateDataDomains', domainUses, doNotHandleFail);
            };
            CNDSMetadata.GetForDataMarts = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSMetadata/GetForDataMarts' + params, doNotHandleFail);
            };
            CNDSMetadata.GetForUsers = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSMetadata/GetForUsers' + params, doNotHandleFail);
            };
            return CNDSMetadata;
        }());
        WebApi.CNDSMetadata = CNDSMetadata;
        var CNDSNetworks = (function () {
            function CNDSNetworks() {
            }
            CNDSNetworks.List = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSNetworks/List' + params, doNotHandleFail);
            };
            CNDSNetworks.Register = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSNetworks/Register', dto, doNotHandleFail);
            };
            CNDSNetworks.Update = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSNetworks/Update', dto, doNotHandleFail);
            };
            CNDSNetworks.Delete = function (id, doNotHandleFail) {
                var params = '';
                if (id != null)
                    params += '&id=' + id;
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.DeleteAPIValue('CNDSNetworks/Delete' + params, doNotHandleFail);
            };
            return CNDSNetworks;
        }());
        WebApi.CNDSNetworks = CNDSNetworks;
        var CNDSRequests = (function () {
            function CNDSRequests() {
            }
            CNDSRequests.Register = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequests/Register', dto, doNotHandleFail);
            };
            CNDSRequests.UpdateRoutingStatus = function (dtos, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequests/UpdateRoutingStatus', dtos, doNotHandleFail);
            };
            CNDSRequests.UpdatePriorityAndDueDate = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequests/UpdatePriorityAndDueDate', dto, doNotHandleFail);
            };
            CNDSRequests.ResubmitRoute = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequests/ResubmitRoute', dto, doNotHandleFail);
            };
            CNDSRequests.TerminateRoute = function (id, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequests/TerminateRoute', id, doNotHandleFail);
            };
            CNDSRequests.TerminateRequest = function (id, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequests/TerminateRequest', id, doNotHandleFail);
            };
            return CNDSRequests;
        }());
        WebApi.CNDSRequests = CNDSRequests;
        var CNDSRequestTypes = (function () {
            function CNDSRequestTypes() {
            }
            CNDSRequestTypes.ListAvailableRequestTypes = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/ListAvailableRequestTypes' + params, doNotHandleFail);
            };
            CNDSRequestTypes.ListAvailableNetworkRoutes = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/ListAvailableNetworkRoutes' + params, doNotHandleFail);
            };
            CNDSRequestTypes.ValidateNetworkRequestTypeMappings = function (dtos, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequestTypes/ValidateNetworkRequestTypeMappings', dtos, doNotHandleFail);
            };
            CNDSRequestTypes.CreateNetworkRequestTypeMapping = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequestTypes/CreateNetworkRequestTypeMapping', dto, doNotHandleFail);
            };
            CNDSRequestTypes.ListMappings = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/ListMappings' + params, doNotHandleFail);
            };
            CNDSRequestTypes.GetNetworkRequestTypeMapping = function (id, doNotHandleFail) {
                var params = '';
                if (id != null)
                    params += '&id=' + id;
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/GetNetworkRequestTypeMapping' + params, doNotHandleFail);
            };
            CNDSRequestTypes.DeleteMapping = function (mappingID, doNotHandleFail) {
                var params = '';
                if (mappingID != null)
                    for (var j = 0; j < mappingID.length; j++) {
                        params += '&mappingID=' + mappingID[j];
                    }
                if (params.length > 0)
                    params = '?' + params.substr(1);
            ...
            CNDSRequestTypes.AvailableRequestTypesForNewRequest = function (id, $filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/AvailableRequestTypesForNewRequest' + params, doNotHandleFail);
            };
            CNDSRequestTypes.ListNetworkRequestTypeDefinitions = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/ListNetworkRequestTypeDefinitions' + params, doNotHandleFail);
            };
            CNDSRequestTypes.GetNetworkRequestTypeDefinition = function (id, doNotHandleFail) {
                var params = '';
                if (id != null)
                    params += '&id=' + id;
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSRequestTypes/GetNetworkRequestTypeDefinition' + params, doNotHandleFail);
            };
            CNDSRequestTypes.ValidateNetworkRequestTypeDefinition = function (dtos, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequestTypes/ValidateNetworkRequestTypeDefinition', dtos, doNotHandleFail);
            };
            CNDSRequestTypes.CreateOrUpdateNetworkRequestTypeDefinition = function (dtos, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSRequestTypes/CreateOrUpdateNetworkRequestTypeDefinition', dtos, doNotHandleFail);
            };
            CNDSRequestTypes.DeleteNetworkRequestTypeDefinitions = function (ID, doNotHandleFail) {
                var params = '';
                if (ID != null)
                    for (var j = 0; j < ID.length; j++) {
                        params += '&ID=' + ID[j];
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.DeleteAPIValue('CNDSRequestTypes/DeleteNetworkRequestTypeDefinitions' + params, doNotHandleFail);
            };
            return CNDSRequestTypes;
        }());
        WebApi.CNDSRequestTypes = CNDSRequestTypes;
        var CNDSSearch = (function () {
            function CNDSSearch() {
            }
            CNDSSearch.DataSources = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSearch/DataSources' + params, doNotHandleFail);
            };
            CNDSSearch.DataSourcesDomains = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSearch/DataSourcesDomains' + params, doNotHandleFail);
            };
            CNDSSearch.DataSourcesSearch = function (ids, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSSearch/DataSourcesSearch', ids, doNotHandleFail);
            };
            CNDSSearch.OrganizationsDomains = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSearch/OrganizationsDomains' + params, doNotHandleFail);
            };
            CNDSSearch.OrganizationsSearch = function (ids, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSSearch/OrganizationsSearch', ids, doNotHandleFail);
            };
            return CNDSSearch;
        }());
        WebApi.CNDSSearch = CNDSSearch;
        var CNDSSecurity = (function () {
            function CNDSSecurity() {
            }
            CNDSSecurity.SecurityGroupList = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/SecurityGroupList' + params, doNotHandleFail);
            };
            CNDSSecurity.SecurityGroupGet = function (securityGroupID, doNotHandleFail) {
                var params = '';
                if (securityGroupID != null)
                    params += '&securityGroupID=' + securityGroupID;
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/SecurityGroupGet' + params, doNotHandleFail);
            };
            CNDSSecurity.InsertOrUpdateSecurityGroups = function (dtos, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSSecurity/InsertOrUpdateSecurityGroups', dtos, doNotHandleFail);
            };
            CNDSSecurity.SecurityGroupDelete = function (ids, doNotHandleFail) {
                var params = '';
                if (ids != null)
                    for (var j = 0; j < ids.length; j++) {
                        params += '&ids=' + ids[j];
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.DeleteAPIValue('CNDSSecurity/SecurityGroupDelete' + params, doNotHandleFail);
            };
            CNDSSecurity.SecurityGroupUsersList = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/SecurityGroupUsersList' + params, doNotHandleFail);
            };
            CNDSSecurity.GetUserSecurityGroups = function (userID, doNotHandleFail) {
                var params = '';
                if (userID != null)
                    params += '&userID=' + userID;
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/GetUserSecurityGroups' + params, doNotHandleFail);
            };
            CNDSSecurity.SecurityGroupUsersUpdate = function (dto, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSSecurity/SecurityGroupUsersUpdate', dto, doNotHandleFail);
            };
            CNDSSecurity.ListPermissions = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/ListPermissions' + params, doNotHandleFail);
            };
            CNDSSecurity.HasPermissions = function (permissionID, userID, doNotHandleFail) {
                var params = '';
                if (permissionID != null)
                    params += '&permissionID=' + permissionID;
                if (userID != null)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/HasPermissions' + params, doNotHandleFail);
            };
            CNDSSecurity.GetSecurityGroupPermissions = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/GetSecurityGroupPermissions' + params, doNotHandleFail);
            };
            CNDSSecurity.GetCurrentUserPermissions = function ($filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if ($filter)
                    params += '&$filter=' + $filter;
                if ($select)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/GetCurrentUserPermissions' + params, doNotHandleFail);
            };
            CNDSSecurity.GetUserPermissions = function (userID, $filter, $select, $orderby, $skip, $top, doNotHandleFail) {
                var params = '';
                if (userID != null)
                    params += '&userID=' + userID;
                if ($filter)
                ...
                if (params.length > 0)
                    params = '?' + params.substr(1);
                return Helpers.GetAPIResult('CNDSSecurity/GetUserPermissions' + params, doNotHandleFail);
            };
            CNDSSecurity.SetPermissions = function (permissions, doNotHandleFail) {
                return Helpers.PostAPIValue('CNDSSecurity/SetPermissions', permissions, doNotHandleFail);
            };
            return CNDSSecurity;
        }());
        WebApi.CNDSSecurity = CNDSSecurity;
