...
module Dns.Enums
{
	 ...
	 export var AccessTypeTranslation: Dns.Structures.KeyValuePair[] = [
	 ...
	 export var OrganizationTypeTranslation: Dns.Structures.KeyValuePair[] = [
	 	 {value:OrganizationType.Local , text: 'Local'},
	 	 {value:OrganizationType.Network , text: 'Network'},
	 ]
	 ...
	 export var RoutingTypeTranslation: Dns.Structures.KeyValuePair[] = [
	 	 {value:RoutingType.AnalysisCenter , text: 'AnalysisCenter'},
	 	 {value:RoutingType.DataPartner , text: 'DataPartner'},
	 	 {value:RoutingType.SourceCNDS , text: 'SourceCNDS'},
	 	 {value:RoutingType.ExternalCNDS , text: 'ExternalCNDS'},
	 ]
	 ...
	 export var UserTypesTranslation: Dns.Structures.KeyValuePair[] = [
	 	 ...
	 	 {value:UserTypes.CNDSNetworkProxy , text: 'CNDSNetworkProxy'},
	 ]
...
module Dns.Interfaces
{
	 ...
	 export interface IMetadataDTO{
	 	 ...
	 	 Value: string;
	 	 ChildMetadata: IMetadataDTO[];
	 	 References: IDomainReferenceDTO[];
	 	 Visibility: any;
	 }
	 export var KendoModelMetadataDTO: any = {
	 	 fields: {
	 	 	...
	 	 	'EntityType': { type:'any', nullable: true},
	 	 	...
	 	 	'Visibility': { type:'any', nullable: false},
	 	 }
	 }
	 export interface ICNDSAssignedPermissionDTO{
	 	 SecurityGroupID: any;
	 	 PermissionID: any;
	 	 Allowed: boolean;
	 }
	 export var KendoModelCNDSAssignedPermissionDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSDataSourceExtendedDTO{
	 	 ID?: any;
	 	 Name: string;
	 	 Acronym: string;
	 	 OrganizationID: any;
	 ...
	 export var KendoModelCNDSDataSourceExtendedDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSNetworkDTO{
	 	 ID: any;
	 	 Name: string;
	 	 Url: string;
	 	 ServiceUrl: string;
	 ...
	 export var KendoModelCNDSNetworkDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'Name': { type:'string', nullable: false},
	 ...
	 export interface ICNDSPermissionsDTO{
	 	 ID: any;
	 	 Name: string;
	 	 Description: string;
	 }
	 export var KendoModelCNDSPermissionsDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'Name': { type:'string', nullable: false},
	 	 	'Description': { type:'string', nullable: false},
	 ...
	 export interface ICNDSProjectRequestTypeDataMartDTO{
	 	 ProjectID: any;
	 	 Project: string;
	 	 DataMartID: any;
	 	 DataMart: string;
	 ...
	 export var KendoModelCNDSProjectRequestTypeDataMartDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSRegisterRequestDTO{
	 	 SourceNetworkID: any;
	 	 ...
	 	 Routes: ICNDSRegisterRouteDTO[];
	 	 Documents: ICNDSRegisterDocumentDTO[];
	 }
	 export var KendoModelCNDSRegisterRequestDTO: any = {
	 	 fields: {
	 	 	'SourceNetworkID': { type:'any', nullable: false},
	 	 	'SourceNetworkName': { type:'string', nullable: false},
	 	 	'ParticipantID': { type:'any', nullable: false},
	 	 	'ProjectID': { type:'any', nullable: false},
	 	 	'RequestTypeID': { type:'any', nullable: false},
	 	 	'RequestDetails': { type:'string', nullable: false},
	 	 	'Routes': { type:'any[]', nullable: false},
	 	 	'Documents': { type:'any[]', nullable: false},
	 	 }
	 }
	 export interface ICNDSRegisterRouteDTO{
	 	 RouteID: any;
	 	 DataMartID: any;
	 	 DueDate?: Date;
	 ...
	 export var KendoModelCNDSRegisterRouteDTO: any = {
	 	 fields: {
	 	 	'RouteID': { type:'any', nullable: false},
	 	 	'DataMartID': { type:'any', nullable: false},
	 	 	'DueDate': { type:'date', nullable: true},
	 	 	'Priority': { type:'dns.enums.priorities', nullable: false},
	 	 	'ResponseID': { type:'any', nullable: false},
	 	 	'DocumentIDs': { type:'any[]', nullable: false},
	 	 }
	 }
	 export interface ICNDSRegisterDocumentDTO{
	 	 SourceDocumentID: any;
	 	 SourceRevisionSetID: any;
	 	 DocumentID: any;
	 	 RevisionSetID: any;
	 	 Name: string;
	 	 IsViewable: boolean;
	 ...
	 export var KendoModelCNDSRegisterDocumentDTO: any = {
	 	 fields: {
	 	 	'SourceDocumentID': { type:'any', nullable: false},
	 	 	'SourceRevisionSetID': { type:'any', nullable: false},
	 ...
	 export interface ICNDSResubmitRouteDTO{
	 	 ResponseID: any;
	 	 RequestDatamartID: any;
	 	 Message: string;
	 }
	 export var KendoModelCNDSResubmitRouteDTO: any = {
	 	 fields: {
	 	 	'ResponseID': { type:'any', nullable: false},
	 ...
	 export interface ICNDSSecurityGroupDTO{
	 	 ID: any;
	 	 Name: string;
	 }
	 export var KendoModelCNDSSecurityGroupDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'Name': { type:'string', nullable: false},
	 	 }
	 }
	 export interface ICNDSSecurityGroupUserDTO{
	 	 UserID: any;
	 	 SecurityGroups: ICNDSSecurityGroupDTO[];
	 }
	 export var KendoModelCNDSSecurityGroupUserDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSMappingItemDTO{
	 	 ID: any;
	 	 Name: string;
	 	 Children: ICNDSMappingItemDTO[];
	 }
	 export var KendoModelCNDSMappingItemDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'Name': { type:'string', nullable: false},
	 	 	'Children': { type:'any[]', nullable: false},
	 	 }
	 }
	 export interface ICNDSUpdateRoutingStatusDTO{
	 	 NetworkID: any;
	 	 Network: string;
	 	 ResponseID: any;
	 ...
	 export var KendoModelCNDSUpdateRoutingStatusDTO: any = {
	 	 fields: {
	 	 	'NetworkID': { type:'any', nullable: false},
	 	 	'Network': { type:'string', nullable: false},
	 	 	'ResponseID': { type:'any', nullable: false},
	 ...
	 export interface ICNDSExternalRequestTypeSelectionItemDTO{
	 	 NetworkID: any;
	 	 ProjectID: any;
	 	 Project: string;
	 	 RequestTypeID: any;
	 	 RequestType: string;
	 	 MappingDefinitions: ICNDSNetworkProjectRequestTypeDataMartDTO[];
	 }
	 export var KendoModelCNDSExternalRequestTypeSelectionItemDTO: any = {
	 	 fields: {
	 	 	'NetworkID': { type:'any', nullable: false},
	 	 	'ProjectID': { type:'any', nullable: false},
	 	 	'Project': { type:'string', nullable: false},
	 	 	'RequestTypeID': { type:'any', nullable: false},
	 	 	'RequestType': { type:'string', nullable: false},
	 	 	'MappingDefinitions': { type:'any[]', nullable: false},
	 	 }
	 }
	 ...
	 export interface ICreateCNDSRequestDetailsDTO{
	 	 DemandActivityResultID?: any;
	 	 Dto: IRequestDTO;
	 	 Routes: ICNDSNetworkProjectRequestTypeDataMartDTO[];
	 	 Data: string;
	 	 Comment: string;
	 }
	 export var KendoModelCreateCNDSRequestDetailsDTO: any = {
	 	 fields: {
	 	 	'DemandActivityResultID': { type:'any', nullable: true},
	 	 	'Dto': { type:'any', nullable: false},
	 	 	'Routes': { type:'any[]', nullable: false},
	 ...
	 export interface IDomainUseReturnDTO{
	 	 ID: any;
	 	 DomainUseID?: any;
	 	 Checked: boolean;
	 	 EntityType: any;
	 }
	 export var KendoModelDomainUseReturnDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'DomainUseID': { type:'any', nullable: true},
	 	 	'Checked': { type:'boolean', nullable: false},
	 	 	'EntityType': { type:'any', nullable: false},
	 	 }
	 }
	 export interface IDomainDTO{
	 	 ...
	 	 DataType: string;
	 	 Children: IDomainDTO[];
	 	 DomainReferences: IDomainReferenceDTO[];
	 }
	 export var KendoModelDomainDTO: any = {
	 	 fields: {
	 	 	...
	 	 	'DataType': { type:'string', nullable: false},
	 	 	'Children': { type:'any[]', nullable: false},
	 	 	'DomainReferences': { type:'any[]', nullable: false},
	 	 }
	 }
	 ...
	 export var KendoModelDomainReferenceDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'DomainID': { type:'any', nullable: true},
	 	 	'ParentDomainReferenceID': { type:'any', nullable: true},
	 	 	'Title': { type:'string', nullable: false},
	 	 	'Description': { type:'string', nullable: false},
	 	 	'Value': { type:'string', nullable: false},
	 ...
	 export interface ICNDSOrganizationSearchDTO{
	 	 ID: any;
	 	 NetworkID: any;
	 	 Network: string;
	 	 Name: string;
	 ...
	 export var KendoModelCNDSOrganizationSearchDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'NetworkID': { type:'any', nullable: false},
	 	 	'Network': { type:'string', nullable: false},
	 ...
	 export interface ICNDSDataSourceSearchDTO{
	 	 ID: any;
	 	 NetworkID: any;
	 	 Network: string;
	 	 OrganizationID: any;
	 ...
	 export var KendoModelCNDSDataSourceSearchDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'NetworkID': { type:'any', nullable: false},
	 	 	'Network': { type:'string', nullable: false},
	 ...
	 export interface ICNDSSearchMetaDataDTO{
	 	 ID: any;
	 	 ParentDomainID?: any;
	 	 Title: string;
	 	 ChildMetadata: ICNDSSearchMetaDataDTO[];
	 	 References: IDomainReferenceDTO[];
	 	 SelectedDisplay: string;
	 }
	 export var KendoModelCNDSSearchMetaDataDTO: any = {
	 	 fields: {
	 	 	'ID': { type:'any', nullable: false},
	 	 	'ParentDomainID': { type:'any', nullable: true},
	 	 	'Title': { type:'string', nullable: false},
	 	 	'ChildMetadata': { type:'any[]', nullable: false},
	 	 	'References': { type:'any[]', nullable: false},
	 	 	'SelectedDisplay': { type:'string', nullable: false},
	 	 }
	 }
	 export interface ICNDSUpdateDataMartPriorityAndDueDateDTO{
	 	 RequestDataMartID?: any;
	 	 Priority: number;
	 	 DueDate?: Date;
	 }
	 export var KendoModelCNDSUpdateDataMartPriorityAndDueDateDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSDomainSearchDTO{
	 	 DomainIDs: any[];
	 	 DomainReferences: any[];
	 }
	 export var KendoModelCNDSDomainSearchDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSUpdateAssignedPermissionDTO extends ICNDSAssignedPermissionDTO{
	 	 Delete: boolean;
	 }
	 export var KendoModelCNDSUpdateAssignedPermissionDTO: any = {
	 	 fields: {
	 ...
	 export interface ICNDSNetworkRequestTypeDefinitionDTO extends IEntityDtoWithID{
	 	 NetworkID: any;
	 	 Network: string;
	 	 ProjectID: any;
	 	 Project: string;
	 ...
	 export var KendoModelCNDSNetworkRequestTypeDefinitionDTO: any = {
	 	 fields: {
	 	 	'NetworkID': { type:'any', nullable: false},
	 	 	'Network': { type:'string', nullable: false},
	 	 	'ProjectID': { type:'any', nullable: false},
	 ...
	 export interface ICNDSNetworkRequestTypeMappingDTO extends IEntityDtoWithID{
	 	 NetworkID: any;
	 	 Network: string;
	 	 ProjectID: any;
	 	 Project: string;
	 	 RequestTypeID: any;
	 	 RequestType: string;
	 	 Routes: ICNDSNetworkRequestTypeDefinitionDTO[];
	 }
	 export var KendoModelCNDSNetworkRequestTypeMappingDTO: any = {
	 	 fields: {
	 	 	'NetworkID': { type:'any', nullable: false},
	 	 	'Network': { type:'string', nullable: false},
	 	 	'ProjectID': { type:'any', nullable: false},
	 ...
	 export var KendoModelRequestDTO: any = {
	 	 fields: {
	 	 	...
	 	 	'IsProxyRequest': { type:'boolean', nullable: false},
	 	 	'ID': { type:'any', nullable: true},
	 	 	'Timestamp': { type:'any', nullable: false},
	 	 }
	 }
	 ...
	 export var KendoModelUserDTO: any = {
	 	 fields: {
	 	 	...
	 	 	'UserType': { type:'dns.enums.usertypes', nullable: false},
	 	 	'Metadata': { type:'any[]', nullable: false},
	 	 	'ID': { type:'any', nullable: true},
	 	 	'Timestamp': { type:'any', nullable: false},
	 	 }
