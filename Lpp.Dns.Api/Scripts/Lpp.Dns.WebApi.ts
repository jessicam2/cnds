...
module Dns.WebApi {
	 ...
	 export class Users{
	 	 ...
	 	 public static GetAvailableUserMetadata($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IMetadataDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IMetadataDTO[]>('Users/GetAvailableUserMetadata' + params, doNotHandleFail);
	 	 }
	 	 ...
	 	 public static UpdateUserVisibility(userMetadata: Dns.Interfaces.IMetadataDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('Users/UpdateUserVisibility', userMetadata, doNotHandleFail);
	 	 }
	 ...
	 export class Organizations{
	 	 ...
	 	 public static GetAvailableOrganizationMetadata($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IMetadataDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IMetadataDTO[]>('Organizations/GetAvailableOrganizationMetadata' + params, doNotHandleFail);
	 	 }
	 	 ...
	 	 public static GetForUser(userID: any,$filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IOrganizationDTO[]>{
	 	 	 var params = '';
	 	 	 if (userID != null) params += '&userID=' + userID;
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IOrganizationDTO[]>('Organizations/GetForUser' + params, doNotHandleFail);
	 	 }
	 	 ...
	 	 public static UpdateOrganizationVisibility(orgMetadata: Dns.Interfaces.IMetadataDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('Organizations/UpdateOrganizationVisibility', orgMetadata, doNotHandleFail);
	 	 }
	 ...
	 export class DataMarts{
	 	 ...
	 	 public static GetAvailableDataMartMetadata($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IMetadataDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IMetadataDTO[]>('DataMarts/GetAvailableDataMartMetadata' + params, doNotHandleFail);
	 	 }
	 	 ...
	 	 public static UpdateDataMartVisibility(dmMetadata: Dns.Interfaces.IMetadataDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('DataMarts/UpdateDataMartVisibility', dmMetadata, doNotHandleFail);
	 	 }
	 ...
	 export class Requests{
	 	 public static CreateRequest(details: Dns.Interfaces.ICreateCNDSRequestDetailsDTO, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IRequestCompletionResponseDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.IRequestCompletionResponseDTO[]>('Requests/CreateRequest', details, doNotHandleFail);
	 	 }
	 	 ...
	 	 public static GetExternalRoutesForRequest(requestID: any,$filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IDataMartListDTO[]>{
	 	 	 var params = '';
	 	 	 if (requestID != null) params += '&requestID=' + requestID;
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IDataMartListDTO[]>('Requests/GetExternalRoutesForRequest' + params, doNotHandleFail);
	 	 }
	 ...
	 export class Documents{
	 	 ...
	 	 public static UploadResponseOutput( doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('Documents/UploadResponseOutput', doNotHandleFail);
	 	 }
	 ...
	 export class CNDSMetadata{
	 	 public static ListDomains($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IMetadataDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IMetadataDTO[]>('CNDSMetadata/ListDomains' + params, doNotHandleFail);
	 	 }

	 	 public static InsertOrUpdateDomains(metaData: Dns.Interfaces.IMetadataDTO[], doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IMetadataDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.IMetadataDTO[]>('CNDSMetadata/InsertOrUpdateDomains', metaData, doNotHandleFail);
	 	 }

	 	 public static GetForOrganization($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IDomainDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IDomainDTO[]>('CNDSMetadata/GetForOrganization' + params, doNotHandleFail);
	 	 }

	 	 public static InsertorUpdateDataDomains(domainUses: Dns.Interfaces.IDomainUseReturnDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSMetadata/InsertorUpdateDataDomains', domainUses, doNotHandleFail);
	 	 }

	 	 public static GetForDataMarts($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IDomainDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IDomainDTO[]>('CNDSMetadata/GetForDataMarts' + params, doNotHandleFail);
	 	 }

	 	 public static GetForUsers($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.IDomainDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.IDomainDTO[]>('CNDSMetadata/GetForUsers' + params, doNotHandleFail);
	 	 }

	 }
	 export class CNDSNetworks{
	 	 public static List($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSNetworkDTO[]>('CNDSNetworks/List' + params, doNotHandleFail);
	 	 }

	 	 public static Register(dto: Dns.Interfaces.ICNDSNetworkDTO, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.ICNDSNetworkDTO[]>('CNDSNetworks/Register', dto, doNotHandleFail);
	 	 }

	 	 public static Update(dto: Dns.Interfaces.ICNDSNetworkDTO, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSNetworks/Update', dto, doNotHandleFail);
	 	 }
	 	 ...
	 	 public static Delete(id: any, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 ...
	 	 	 return Helpers.DeleteAPIValue<any[]>('CNDSNetworks/Delete' + params, doNotHandleFail);
	 	 }

	 }
	 export class CNDSRequests{
	 	 public static Register(dto: Dns.Interfaces.ICNDSRegisterRequestDTO, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequests/Register', dto, doNotHandleFail);
	 	 }

	 	 public static UpdateRoutingStatus(dtos: Dns.Interfaces.ICNDSUpdateRoutingStatusDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequests/UpdateRoutingStatus', dtos, doNotHandleFail);
	 	 }

	 	 public static UpdatePriorityAndDueDate(dto: Dns.Interfaces.ICNDSUpdateDataMartPriorityAndDueDateDTO, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequests/UpdatePriorityAndDueDate', dto, doNotHandleFail);
	 	 }

	 	 public static ResubmitRoute(dto: Dns.Interfaces.ICNDSResubmitRouteDTO, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequests/ResubmitRoute', dto, doNotHandleFail);
	 	 }

	 	 public static TerminateRoute(id: any, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequests/TerminateRoute', id, doNotHandleFail);
	 	 }

	 	 public static TerminateRequest(id: any, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequests/TerminateRequest', id, doNotHandleFail);
	 	 }

	 }
	 export class CNDSRequestTypes{
	 	 public static ListAvailableRequestTypes($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSProjectRequestTypeDataMartDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSProjectRequestTypeDataMartDTO[]>('CNDSRequestTypes/ListAvailableRequestTypes' + params, doNotHandleFail);
	 	 }

	 	 public static ListAvailableNetworkRoutes($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSMappingItemDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSMappingItemDTO[]>('CNDSRequestTypes/ListAvailableNetworkRoutes' + params, doNotHandleFail);
	 	 }

	 	 public static ValidateNetworkRequestTypeMappings(dtos: Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[], doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[]>('CNDSRequestTypes/ValidateNetworkRequestTypeMappings', dtos, doNotHandleFail);
	 	 }

	 	 public static CreateNetworkRequestTypeMapping(dto: Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSRequestTypes/CreateNetworkRequestTypeMapping', dto, doNotHandleFail);
	 	 }

	 	 public static ListMappings($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[]>('CNDSRequestTypes/ListMappings' + params, doNotHandleFail);
	 	 }

	 	 public static GetNetworkRequestTypeMapping(id: any, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[]>{
	 	 	 var params = '';
	 	 	 if (id != null) params += '&id=' + id;
	 	 	 if (params.length > 0)
	 	 	 	 params = '?' + params.substr(1);

	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSNetworkRequestTypeMappingDTO[]>('CNDSRequestTypes/GetNetworkRequestTypeMapping' + params, doNotHandleFail);
	 	 }

	 	 public static DeleteMapping(mappingID: any[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 var params = '';
	 	 	 if (mappingID != null)
	 	 	 	 for(var j = 0; j < mappingID.length; j++) { params += '&mappingID=' + mappingID[j]; }
	 	 	 if (params.length > 0)
	 	 	 	 params = '?' + params.substr(1);
	 	 ...
	 	 public static ListNetworkRequestTypeDefinitions($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>{
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>('CNDSRequestTypes/ListNetworkRequestTypeDefinitions' + params, doNotHandleFail);
	 	 }

	 	 public static GetNetworkRequestTypeDefinition(id: any, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>{
	 	 	 var params = '';
	 	 	 if (id != null) params += '&id=' + id;
	 	 	 if (params.length > 0)
	 	 	 	 params = '?' + params.substr(1);

	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>('CNDSRequestTypes/GetNetworkRequestTypeDefinition' + params, doNotHandleFail);
	 	 }

	 	 public static ValidateNetworkRequestTypeDefinition(dtos: Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[], doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>('CNDSRequestTypes/ValidateNetworkRequestTypeDefinition', dtos, doNotHandleFail);
	 	 }

	 	 public static CreateOrUpdateNetworkRequestTypeDefinition(dtos: Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[], doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.ICNDSNetworkRequestTypeDefinitionDTO[]>('CNDSRequestTypes/CreateOrUpdateNetworkRequestTypeDefinition', dtos, doNotHandleFail);
	 	 }

	 	 public static DeleteNetworkRequestTypeDefinitions(ID: any[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 var params = '';
	 	 	 if (ID != null)
	 	 	 	 for(var j = 0; j < ID.length; j++) { params += '&ID=' + ID[j]; }
	 	 	 if (params.length > 0)
	 	 	 ...
	 	 	 return Helpers.DeleteAPIValue<any[]>('CNDSRequestTypes/DeleteNetworkRequestTypeDefinitions' + params, doNotHandleFail);
	 	 }

	 }
	 export class CNDSSearch{
	 	 public static DataSources($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSDataSourceExtendedDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSDataSourceExtendedDTO[]>('CNDSSearch/DataSources' + params, doNotHandleFail);
	 	 }

	 	 public static DataSourcesDomains($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSSearchMetaDataDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSSearchMetaDataDTO[]>('CNDSSearch/DataSourcesDomains' + params, doNotHandleFail);
	 	 }

	 	 public static DataSourcesSearch(ids: Dns.Interfaces.ICNDSDomainSearchDTO, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSDataSourceSearchDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.ICNDSDataSourceSearchDTO[]>('CNDSSearch/DataSourcesSearch', ids, doNotHandleFail);
	 	 }

	 	 public static OrganizationsDomains($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSSearchMetaDataDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSSearchMetaDataDTO[]>('CNDSSearch/OrganizationsDomains' + params, doNotHandleFail);
	 	 }

	 	 public static OrganizationsSearch(ids: Dns.Interfaces.ICNDSDomainSearchDTO, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSOrganizationSearchDTO[]>{
	 	 	 return Helpers.PostAPIValue<Dns.Interfaces.ICNDSOrganizationSearchDTO[]>('CNDSSearch/OrganizationsSearch', ids, doNotHandleFail);
	 	 }

	 }
	 export class CNDSSecurity{
	 	 public static SecurityGroupList($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSSecurityGroupDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSSecurityGroupDTO[]>('CNDSSecurity/SecurityGroupList' + params, doNotHandleFail);
	 	 }

	 	 public static SecurityGroupGet(securityGroupID: any, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSSecurityGroupDTO[]>{
	 	 	 var params = '';
	 	 	 if (securityGroupID != null) params += '&securityGroupID=' + securityGroupID;
	 	 	 if (params.length > 0)
	 	 	 	 params = '?' + params.substr(1);

	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSSecurityGroupDTO[]>('CNDSSecurity/SecurityGroupGet' + params, doNotHandleFail);
	 	 }

	 	 public static InsertOrUpdateSecurityGroups(dtos: Dns.Interfaces.ICNDSSecurityGroupDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSSecurity/InsertOrUpdateSecurityGroups', dtos, doNotHandleFail);
	 	 }

	 	 public static SecurityGroupDelete(ids: any[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 var params = '';
	 	 	 if (ids != null)
	 	 	 	 for(var j = 0; j < ids.length; j++) { params += '&ids=' + ids[j]; }
	 	 	 if (params.length > 0)
	 	 	 ...
	 	 	 return Helpers.DeleteAPIValue<any[]>('CNDSSecurity/SecurityGroupDelete' + params, doNotHandleFail);
	 	 }

	 	 public static SecurityGroupUsersList($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSSecurityGroupUserDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSSecurityGroupUserDTO[]>('CNDSSecurity/SecurityGroupUsersList' + params, doNotHandleFail);
	 	 }

	 	 public static GetUserSecurityGroups(userID: any, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSSecurityGroupUserDTO[]>{
	 	 	 var params = '';
	 	 	 if (userID != null) params += '&userID=' + userID;
	 	 	 if (params.length > 0)
	 	 	 	 params = '?' + params.substr(1);

	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSSecurityGroupUserDTO[]>('CNDSSecurity/GetUserSecurityGroups' + params, doNotHandleFail);
	 	 }

	 	 public static SecurityGroupUsersUpdate(dto: Dns.Interfaces.ICNDSSecurityGroupUserDTO, doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSSecurity/SecurityGroupUsersUpdate', dto, doNotHandleFail);
	 	 }

	 	 public static ListPermissions($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSPermissionsDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSPermissionsDTO[]>('CNDSSecurity/ListPermissions' + params, doNotHandleFail);
	 	 }

	 	 public static HasPermissions(permissionID: any, userID: any, doNotHandleFail?: boolean):JQueryDeferred<boolean[]>{
	 	 	 var params = '';
	 	 	 if (permissionID != null) params += '&permissionID=' + permissionID;
	 	 	 if (userID != null) params += '&userID=' + userID;
	 	 	 if (params.length > 0)
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<boolean[]>('CNDSSecurity/HasPermissions' + params, doNotHandleFail);
	 	 }

	 	 public static GetSecurityGroupPermissions($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSAssignedPermissionDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSAssignedPermissionDTO[]>('CNDSSecurity/GetSecurityGroupPermissions' + params, doNotHandleFail);
	 	 }

	 	 public static GetCurrentUserPermissions($filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSAssignedPermissionDTO[]>{
	 	 	 var params = '';
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			if($orderby) params += '&$orderby=' + $orderby;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSAssignedPermissionDTO[]>('CNDSSecurity/GetCurrentUserPermissions' + params, doNotHandleFail);
	 	 }

	 	 public static GetUserPermissions(userID: any,$filter?: string, $select?: string, $orderby?: string, $skip?: number, $top?: number, doNotHandleFail?: boolean):JQueryDeferred<Dns.Interfaces.ICNDSAssignedPermissionDTO[]>{
	 	 	 var params = '';
	 	 	 if (userID != null) params += '&userID=' + userID;
             if($filter) params += '&$filter=' + $filter;
			if($select) params += '&$select=' + $select;
			...
			if($top) params += '&$top=' + $top;
	 	 	 ...
	 	 	 return Helpers.GetAPIResult<Dns.Interfaces.ICNDSAssignedPermissionDTO[]>('CNDSSecurity/GetUserPermissions' + params, doNotHandleFail);
	 	 }

	 	 public static SetPermissions(permissions: Dns.Interfaces.ICNDSUpdateAssignedPermissionDTO[], doNotHandleFail?: boolean):JQueryDeferred<any[]>{
	 	 	 return Helpers.PostAPIValue<any[]>('CNDSSecurity/SetPermissions', permissions, doNotHandleFail);
	 	 }
