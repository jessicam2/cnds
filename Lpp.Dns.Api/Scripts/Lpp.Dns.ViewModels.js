...
(function (Dns) {
    ...
    (function (ViewModels) {
        ...
        var MetadataViewModel = (function (_super) {
            __extends(MetadataViewModel, _super);
            function MetadataViewModel(MetadataDTO) {
                ...
                if (MetadataDTO == null) {
                    ...
                    _this.ID = ko.observable(MetadataDTO.ID);
                    _this.EntityID = ko.observable(MetadataDTO.EntityID);
                    _this.DomainReferenceID = ko.observable(MetadataDTO.DomainReferenceID);
                    _this.Title = ko.observable(MetadataDTO.Title);
                    _this.Description = ko.observable(MetadataDTO.Description);
                    _this.IsMultiValue = ko.observable(MetadataDTO.IsMultiValue);
                    _this.EnumValue = ko.observable(MetadataDTO.EnumValue);
                    _this.DataType = ko.observable(MetadataDTO.DataType);
                    _this.EntityType = ko.observable(MetadataDTO.EntityType);
                    _this.DomainUseID = ko.observable(MetadataDTO.DomainUseID);
                    _this.ParentDomainReferenceID = ko.observable(MetadataDTO.ParentDomainReferenceID);
                    _this.Value = ko.observable(MetadataDTO.Value);
                    _this.ChildMetadata = ko.observableArray(MetadataDTO.ChildMetadata == null ? null : MetadataDTO.ChildMetadata.map(function (item) { return new MetadataViewModel(item); }));
                    _this.References = ko.observableArray(MetadataDTO.References == null ? null : MetadataDTO.References.map(function (item) { return new DomainReferenceViewModel(item); }));
                    _this.Visibility = ko.observable(MetadataDTO.Visibility);
                }
                return _this;
            }
        ...
        ViewModels.MetadataViewModel = MetadataViewModel;
        var CNDSAssignedPermissionViewModel = (function (_super) {
            __extends(CNDSAssignedPermissionViewModel, _super);
            function CNDSAssignedPermissionViewModel(CNDSAssignedPermissionDTO) {
                var _this = _super.call(this) || this;
                if (CNDSAssignedPermissionDTO == null) {
                    ...
                    _this.SecurityGroupID = ko.observable(CNDSAssignedPermissionDTO.SecurityGroupID);
                    _this.PermissionID = ko.observable(CNDSAssignedPermissionDTO.PermissionID);
                    _this.Allowed = ko.observable(CNDSAssignedPermissionDTO.Allowed);
                }
                return _this;
            }
            CNDSAssignedPermissionViewModel.prototype.toData = function () {
                return {
            ...
            return CNDSAssignedPermissionViewModel;
        }(ViewModel));
        ViewModels.CNDSAssignedPermissionViewModel = CNDSAssignedPermissionViewModel;
        var CNDSDataSourceExtendedViewModel = (function (_super) {
            __extends(CNDSDataSourceExtendedViewModel, _super);
            function CNDSDataSourceExtendedViewModel(CNDSDataSourceExtendedDTO) {
                var _this = _super.call(this) || this;
                if (CNDSDataSourceExtendedDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSDataSourceExtendedDTO.ID);
                    _this.Name = ko.observable(CNDSDataSourceExtendedDTO.Name);
                    _this.Acronym = ko.observable(CNDSDataSourceExtendedDTO.Acronym);
                    _this.OrganizationID = ko.observable(CNDSDataSourceExtendedDTO.OrganizationID);
                    _this.AdapterSupportedID = ko.observable(CNDSDataSourceExtendedDTO.AdapterSupportedID);
                    _this.AdapterSupported = ko.observable(CNDSDataSourceExtendedDTO.AdapterSupported);
                    _this.Organization = ko.observable(CNDSDataSourceExtendedDTO.Organization);
                    _this.NetworkID = ko.observable(CNDSDataSourceExtendedDTO.NetworkID);
                    _this.Network = ko.observable(CNDSDataSourceExtendedDTO.Network);
                }
                return _this;
            }
            CNDSDataSourceExtendedViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    Name: this.Name(),
            ...
            return CNDSDataSourceExtendedViewModel;
        }(ViewModel));
        ViewModels.CNDSDataSourceExtendedViewModel = CNDSDataSourceExtendedViewModel;
        var CNDSNetworkViewModel = (function (_super) {
            __extends(CNDSNetworkViewModel, _super);
            function CNDSNetworkViewModel(CNDSNetworkDTO) {
                var _this = _super.call(this) || this;
                if (CNDSNetworkDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSNetworkDTO.ID);
                    _this.Name = ko.observable(CNDSNetworkDTO.Name);
                    _this.Url = ko.observable(CNDSNetworkDTO.Url);
                    _this.ServiceUrl = ko.observable(CNDSNetworkDTO.ServiceUrl);
                    _this.ServiceUserName = ko.observable(CNDSNetworkDTO.ServiceUserName);
                    _this.ServicePassword = ko.observable(CNDSNetworkDTO.ServicePassword);
                }
                return _this;
            }
            CNDSNetworkViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    Name: this.Name(),
                    Url: this.Url(),
            ...
            return CNDSNetworkViewModel;
        }(ViewModel));
        ViewModels.CNDSNetworkViewModel = CNDSNetworkViewModel;
        var CNDSPermissionsViewModel = (function (_super) {
            __extends(CNDSPermissionsViewModel, _super);
            function CNDSPermissionsViewModel(CNDSPermissionsDTO) {
                var _this = _super.call(this) || this;
                if (CNDSPermissionsDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSPermissionsDTO.ID);
                    _this.Name = ko.observable(CNDSPermissionsDTO.Name);
                    _this.Description = ko.observable(CNDSPermissionsDTO.Description);
                }
                return _this;
            }
            CNDSPermissionsViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    Name: this.Name(),
                    Description: this.Description(),
            ...
            return CNDSPermissionsViewModel;
        }(ViewModel));
        ViewModels.CNDSPermissionsViewModel = CNDSPermissionsViewModel;
        var CNDSProjectRequestTypeDataMartViewModel = (function (_super) {
            __extends(CNDSProjectRequestTypeDataMartViewModel, _super);
            function CNDSProjectRequestTypeDataMartViewModel(CNDSProjectRequestTypeDataMartDTO) {
                var _this = _super.call(this) || this;
                if (CNDSProjectRequestTypeDataMartDTO == null) {
                    ...
                    _this.ProjectID = ko.observable(CNDSProjectRequestTypeDataMartDTO.ProjectID);
                    _this.Project = ko.observable(CNDSProjectRequestTypeDataMartDTO.Project);
                    _this.DataMartID = ko.observable(CNDSProjectRequestTypeDataMartDTO.DataMartID);
                    _this.DataMart = ko.observable(CNDSProjectRequestTypeDataMartDTO.DataMart);
                    _this.RequestTypeID = ko.observable(CNDSProjectRequestTypeDataMartDTO.RequestTypeID);
                    _this.RequestType = ko.observable(CNDSProjectRequestTypeDataMartDTO.RequestType);
                }
                return _this;
            }
            CNDSProjectRequestTypeDataMartViewModel.prototype.toData = function () {
                return {
            ...
            return CNDSProjectRequestTypeDataMartViewModel;
        }(ViewModel));
        ViewModels.CNDSProjectRequestTypeDataMartViewModel = CNDSProjectRequestTypeDataMartViewModel;
        var CNDSRegisterRequestViewModel = (function (_super) {
            __extends(CNDSRegisterRequestViewModel, _super);
            function CNDSRegisterRequestViewModel(CNDSRegisterRequestDTO) {
                var _this = _super.call(this) || this;
                if (CNDSRegisterRequestDTO == null) {
                    _this.SourceNetworkID = ko.observable();
                    _this.SourceNetworkName = ko.observable();
                    _this.ParticipantID = ko.observable();
                    _this.ProjectID = ko.observable();
                    _this.RequestTypeID = ko.observable();
                    _this.RequestDetails = ko.observable();
                    _this.Routes = ko.observableArray();
                    _this.Documents = ko.observableArray();
                }
                else {
                    _this.SourceNetworkID = ko.observable(CNDSRegisterRequestDTO.SourceNetworkID);
                    _this.SourceNetworkName = ko.observable(CNDSRegisterRequestDTO.SourceNetworkName);
                    _this.ParticipantID = ko.observable(CNDSRegisterRequestDTO.ParticipantID);
                    _this.ProjectID = ko.observable(CNDSRegisterRequestDTO.ProjectID);
                    _this.RequestTypeID = ko.observable(CNDSRegisterRequestDTO.RequestTypeID);
                    _this.RequestDetails = ko.observable(CNDSRegisterRequestDTO.RequestDetails);
                    _this.Routes = ko.observableArray(CNDSRegisterRequestDTO.Routes == null ? null : CNDSRegisterRequestDTO.Routes.map(function (item) { return new CNDSRegisterRouteViewModel(item); }));
                    _this.Documents = ko.observableArray(CNDSRegisterRequestDTO.Documents == null ? null : CNDSRegisterRequestDTO.Documents.map(function (item) { return new CNDSRegisterDocumentViewModel(item); }));
                }
                return _this;
            }
            CNDSRegisterRequestViewModel.prototype.toData = function () {
                return {
            ...
            return CNDSRegisterRequestViewModel;
        }(ViewModel));
        ViewModels.CNDSRegisterRequestViewModel = CNDSRegisterRequestViewModel;
        var CNDSRegisterRouteViewModel = (function (_super) {
            __extends(CNDSRegisterRouteViewModel, _super);
            function CNDSRegisterRouteViewModel(CNDSRegisterRouteDTO) {
                var _this = _super.call(this) || this;
                if (CNDSRegisterRouteDTO == null) {
                    _this.RouteID = ko.observable();
                    _this.DataMartID = ko.observable();
                    _this.DueDate = ko.observable();
                    _this.Priority = ko.observable();
                    _this.ResponseID = ko.observable();
                    _this.DocumentIDs = ko.observableArray();
                }
                else {
                    _this.RouteID = ko.observable(CNDSRegisterRouteDTO.RouteID);
                    _this.DataMartID = ko.observable(CNDSRegisterRouteDTO.DataMartID);
                    _this.DueDate = ko.observable(CNDSRegisterRouteDTO.DueDate);
                    _this.Priority = ko.observable(CNDSRegisterRouteDTO.Priority);
                    _this.ResponseID = ko.observable(CNDSRegisterRouteDTO.ResponseID);
                    _this.DocumentIDs = ko.observableArray(CNDSRegisterRouteDTO.DocumentIDs == null ? null : CNDSRegisterRouteDTO.DocumentIDs.map(function (item) { return item; }));
                }
                return _this;
            }
            CNDSRegisterRouteViewModel.prototype.toData = function () {
                return {
            ...
            return CNDSRegisterRouteViewModel;
        }(ViewModel));
        ViewModels.CNDSRegisterRouteViewModel = CNDSRegisterRouteViewModel;
        var CNDSRegisterDocumentViewModel = (function (_super) {
            __extends(CNDSRegisterDocumentViewModel, _super);
            function CNDSRegisterDocumentViewModel(CNDSRegisterDocumentDTO) {
                var _this = _super.call(this) || this;
                if (CNDSRegisterDocumentDTO == null) {
                    _this.SourceDocumentID = ko.observable();
                    _this.SourceRevisionSetID = ko.observable();
                    ...
                    _this.SourceDocumentID = ko.observable(CNDSRegisterDocumentDTO.SourceDocumentID);
                    _this.SourceRevisionSetID = ko.observable(CNDSRegisterDocumentDTO.SourceRevisionSetID);
                    _this.DocumentID = ko.observable(CNDSRegisterDocumentDTO.DocumentID);
                    _this.RevisionSetID = ko.observable(CNDSRegisterDocumentDTO.RevisionSetID);
                    _this.Name = ko.observable(CNDSRegisterDocumentDTO.Name);
                    _this.IsViewable = ko.observable(CNDSRegisterDocumentDTO.IsViewable);
                    _this.Kind = ko.observable(CNDSRegisterDocumentDTO.Kind);
                    _this.MimeType = ko.observable(CNDSRegisterDocumentDTO.MimeType);
                    _this.FileName = ko.observable(CNDSRegisterDocumentDTO.FileName);
                    _this.Length = ko.observable(CNDSRegisterDocumentDTO.Length);
                    _this.Description = ko.observable(CNDSRegisterDocumentDTO.Description);
                }
                return _this;
            }
            CNDSRegisterDocumentViewModel.prototype.toData = function () {
                return {
            ...
            return CNDSRegisterDocumentViewModel;
        }(ViewModel));
        ViewModels.CNDSRegisterDocumentViewModel = CNDSRegisterDocumentViewModel;
        var CNDSResubmitRouteViewModel = (function (_super) {
            __extends(CNDSResubmitRouteViewModel, _super);
            function CNDSResubmitRouteViewModel(CNDSResubmitRouteDTO) {
                var _this = _super.call(this) || this;
                if (CNDSResubmitRouteDTO == null) {
                    ...
                    _this.ResponseID = ko.observable(CNDSResubmitRouteDTO.ResponseID);
                    _this.RequestDatamartID = ko.observable(CNDSResubmitRouteDTO.RequestDatamartID);
                    _this.Message = ko.observable(CNDSResubmitRouteDTO.Message);
                }
                return _this;
            }
            CNDSResubmitRouteViewModel.prototype.toData = function () {
                return {
                    ResponseID: this.ResponseID(),
            ...
            return CNDSResubmitRouteViewModel;
        }(ViewModel));
        ViewModels.CNDSResubmitRouteViewModel = CNDSResubmitRouteViewModel;
        var CNDSSecurityGroupViewModel = (function (_super) {
            __extends(CNDSSecurityGroupViewModel, _super);
            function CNDSSecurityGroupViewModel(CNDSSecurityGroupDTO) {
                var _this = _super.call(this) || this;
                if (CNDSSecurityGroupDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSSecurityGroupDTO.ID);
                    _this.Name = ko.observable(CNDSSecurityGroupDTO.Name);
                }
                return _this;
            }
        ...
        ViewModels.CNDSSecurityGroupViewModel = CNDSSecurityGroupViewModel;
        var CNDSSecurityGroupUserViewModel = (function (_super) {
            __extends(CNDSSecurityGroupUserViewModel, _super);
            function CNDSSecurityGroupUserViewModel(CNDSSecurityGroupUserDTO) {
                var _this = _super.call(this) || this;
                if (CNDSSecurityGroupUserDTO == null) {
                    ...
                    _this.UserID = ko.observable(CNDSSecurityGroupUserDTO.UserID);
                    _this.SecurityGroups = ko.observableArray(CNDSSecurityGroupUserDTO.SecurityGroups == null ? null : CNDSSecurityGroupUserDTO.SecurityGroups.map(function (item) { return new CNDSSecurityGroupViewModel(item); }));
                }
                return _this;
            }
            CNDSSecurityGroupUserViewModel.prototype.toData = function () {
                return {
                    UserID: this.UserID(),
        ...
        var CNDSMappingItemViewModel = (function (_super) {
            ...
            function CNDSMappingItemViewModel(CNDSMappingItemDTO) {
                ...
                if (CNDSMappingItemDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSMappingItemDTO.ID);
                    _this.Name = ko.observable(CNDSMappingItemDTO.Name);
                    _this.Children = ko.observableArray(CNDSMappingItemDTO.Children == null ? null : CNDSMappingItemDTO.Children.map(function (item) { return new CNDSMappingItemViewModel(item); }));
                }
                return _this;
            }
            CNDSMappingItemViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    Name: this.Name(),
                    Children: this.Children == null ? null : this.Children().map(function (item) { return item.toData(); }),
                };
            };
            return CNDSMappingItemViewModel;
        }(ViewModel));
        ViewModels.CNDSMappingItemViewModel = CNDSMappingItemViewModel;
        var CNDSUpdateRoutingStatusViewModel = (function (_super) {
            __extends(CNDSUpdateRoutingStatusViewModel, _super);
            function CNDSUpdateRoutingStatusViewModel(CNDSUpdateRoutingStatusDTO) {
                var _this = _super.call(this) || this;
                if (CNDSUpdateRoutingStatusDTO == null) {
                    ...
                    _this.NetworkID = ko.observable(CNDSUpdateRoutingStatusDTO.NetworkID);
                    _this.Network = ko.observable(CNDSUpdateRoutingStatusDTO.Network);
                    _this.ResponseID = ko.observable(CNDSUpdateRoutingStatusDTO.ResponseID);
                    _this.RoutingStatus = ko.observable(CNDSUpdateRoutingStatusDTO.RoutingStatus);
                    _this.Message = ko.observable(CNDSUpdateRoutingStatusDTO.Message);
                }
                return _this;
            }
            CNDSUpdateRoutingStatusViewModel.prototype.toData = function () {
                return {
                    NetworkID: this.NetworkID(),
                    Network: this.Network(),
                    ResponseID: this.ResponseID(),
            ...
            return CNDSUpdateRoutingStatusViewModel;
        }(ViewModel));
        ViewModels.CNDSUpdateRoutingStatusViewModel = CNDSUpdateRoutingStatusViewModel;
        ...
        var CNDSExternalRequestTypeSelectionItemViewModel = (function (_super) {
            __extends(CNDSExternalRequestTypeSelectionItemViewModel, _super);
            function CNDSExternalRequestTypeSelectionItemViewModel(CNDSExternalRequestTypeSelectionItemDTO) {
                var _this = _super.call(this) || this;
                if (CNDSExternalRequestTypeSelectionItemDTO == null) {
                    ...
                    _this.RequestTypeID = ko.observable();
                    _this.RequestType = ko.observable();
                    _this.MappingDefinitions = ko.observableArray();
                }
                else {
                    _this.NetworkID = ko.observable(CNDSExternalRequestTypeSelectionItemDTO.NetworkID);
                    _this.ProjectID = ko.observable(CNDSExternalRequestTypeSelectionItemDTO.ProjectID);
                    _this.Project = ko.observable(CNDSExternalRequestTypeSelectionItemDTO.Project);
                    _this.RequestTypeID = ko.observable(CNDSExternalRequestTypeSelectionItemDTO.RequestTypeID);
                    _this.RequestType = ko.observable(CNDSExternalRequestTypeSelectionItemDTO.RequestType);
                    _this.MappingDefinitions = ko.observableArray(CNDSExternalRequestTypeSelectionItemDTO.MappingDefinitions == null ? null : CNDSExternalRequestTypeSelectionItemDTO.MappingDefinitions.map(function (item) { return new CNDSNetworkProjectRequestTypeDataMartViewModel(item); }));
                }
                return _this;
            }
            CNDSExternalRequestTypeSelectionItemViewModel.prototype.toData = function () {
                return {
                    NetworkID: this.NetworkID(),
                    ProjectID: this.ProjectID(),
                    Project: this.Project(),
                    RequestTypeID: this.RequestTypeID(),
                    RequestType: this.RequestType(),
                    MappingDefinitions: this.MappingDefinitions == null ? null : this.MappingDefinitions().map(function (item) { return item.toData(); }),
                };
            };
            return CNDSExternalRequestTypeSelectionItemViewModel;
        }(ViewModel));
        ViewModels.CNDSExternalRequestTypeSelectionItemViewModel = CNDSExternalRequestTypeSelectionItemViewModel;
        ...
        var CreateCNDSRequestDetailsViewModel = (function (_super) {
            __extends(CreateCNDSRequestDetailsViewModel, _super);
            function CreateCNDSRequestDetailsViewModel(CreateCNDSRequestDetailsDTO) {
                var _this = _super.call(this) || this;
                if (CreateCNDSRequestDetailsDTO == null) {
                    ...
                    _this.DemandActivityResultID = ko.observable(CreateCNDSRequestDetailsDTO.DemandActivityResultID);
                    _this.Dto = new RequestViewModel(CreateCNDSRequestDetailsDTO.Dto);
                    _this.Routes = ko.observableArray(CreateCNDSRequestDetailsDTO.Routes == null ? null : CreateCNDSRequestDetailsDTO.Routes.map(function (item) { return new CNDSNetworkProjectRequestTypeDataMartViewModel(item); }));
                    _this.Data = ko.observable(CreateCNDSRequestDetailsDTO.Data);
                    _this.Comment = ko.observable(CreateCNDSRequestDetailsDTO.Comment);
                }
                return _this;
            }
            CreateCNDSRequestDetailsViewModel.prototype.toData = function () {
                return {
                    DemandActivityResultID: this.DemandActivityResultID(),
                    Dto: this.Dto.toData(),
                    Routes: this.Routes == null ? null : this.Routes().map(function (item) { return item.toData(); }),
            ...
            return CreateCNDSRequestDetailsViewModel;
        }(ViewModel));
        ViewModels.CreateCNDSRequestDetailsViewModel = CreateCNDSRequestDetailsViewModel;
        ...
        var DomainUseReturnViewModel = (function (_super) {
            __extends(DomainUseReturnViewModel, _super);
            function DomainUseReturnViewModel(DomainUseReturnDTO) {
                var _this = _super.call(this) || this;
                if (DomainUseReturnDTO == null) {
                    _this.ID = ko.observable();
                    _this.DomainUseID = ko.observable();
                    _this.Checked = ko.observable();
                    _this.EntityType = ko.observable();
                }
                else {
                    _this.ID = ko.observable(DomainUseReturnDTO.ID);
                    _this.DomainUseID = ko.observable(DomainUseReturnDTO.DomainUseID);
                    _this.Checked = ko.observable(DomainUseReturnDTO.Checked);
                    _this.EntityType = ko.observable(DomainUseReturnDTO.EntityType);
                }
                return _this;
            }
            DomainUseReturnViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    DomainUseID: this.DomainUseID(),
            ...
            return DomainUseReturnViewModel;
        }(ViewModel));
        ViewModels.DomainUseReturnViewModel = DomainUseReturnViewModel;
        var DomainViewModel = (function (_super) {
            ...
            function DomainViewModel(DomainDTO) {
                ...
                if (DomainDTO == null) {
                    ...
                    _this.DataType = ko.observable();
                    _this.Children = ko.observableArray();
                    _this.DomainReferences = ko.observableArray();
                }
                else {
                    ...
                    _this.Children = ko.observableArray(DomainDTO.Children == null ? null : DomainDTO.Children.map(function (item) { return new DomainViewModel(item); }));
                    _this.DomainReferences = ko.observableArray(DomainDTO.DomainReferences == null ? null : DomainDTO.DomainReferences.map(function (item) { return new DomainReferenceViewModel(item); }));
                }
                return _this;
            }
            DomainViewModel.prototype.toData = function () {
                return {
                    ...
                    DataType: this.DataType(),
                    Children: this.Children == null ? null : this.Children().map(function (item) { return item.toData(); }),
                    DomainReferences: this.DomainReferences == null ? null : this.DomainReferences().map(function (item) { return item.toData(); }),
                };
            };
        ...
        var CNDSOrganizationSearchViewModel = (function (_super) {
            __extends(CNDSOrganizationSearchViewModel, _super);
            function CNDSOrganizationSearchViewModel(CNDSOrganizationSearchDTO) {
                var _this = _super.call(this) || this;
                if (CNDSOrganizationSearchDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSOrganizationSearchDTO.ID);
                    _this.NetworkID = ko.observable(CNDSOrganizationSearchDTO.NetworkID);
                    _this.Network = ko.observable(CNDSOrganizationSearchDTO.Network);
                    _this.Name = ko.observable(CNDSOrganizationSearchDTO.Name);
                    _this.ContactInformation = ko.observable(CNDSOrganizationSearchDTO.ContactInformation);
                }
                return _this;
            }
            CNDSOrganizationSearchViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    NetworkID: this.NetworkID(),
                    Network: this.Network(),
            ...
            return CNDSOrganizationSearchViewModel;
        }(ViewModel));
        ViewModels.CNDSOrganizationSearchViewModel = CNDSOrganizationSearchViewModel;
        var CNDSDataSourceSearchViewModel = (function (_super) {
            __extends(CNDSDataSourceSearchViewModel, _super);
            function CNDSDataSourceSearchViewModel(CNDSDataSourceSearchDTO) {
                var _this = _super.call(this) || this;
                if (CNDSDataSourceSearchDTO == null) {
                    ...
                    _this.ID = ko.observable(CNDSDataSourceSearchDTO.ID);
                    _this.NetworkID = ko.observable(CNDSDataSourceSearchDTO.NetworkID);
                    _this.Network = ko.observable(CNDSDataSourceSearchDTO.Network);
                    _this.OrganizationID = ko.observable(CNDSDataSourceSearchDTO.OrganizationID);
                    _this.Organization = ko.observable(CNDSDataSourceSearchDTO.Organization);
                    _this.Name = ko.observable(CNDSDataSourceSearchDTO.Name);
                    _this.ContactInformation = ko.observable(CNDSDataSourceSearchDTO.ContactInformation);
                }
                return _this;
            }
            CNDSDataSourceSearchViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    NetworkID: this.NetworkID(),
                    Network: this.Network(),
            ...
            return CNDSDataSourceSearchViewModel;
        }(ViewModel));
        ViewModels.CNDSDataSourceSearchViewModel = CNDSDataSourceSearchViewModel;
        var CNDSSearchMetaDataViewModel = (function (_super) {
            __extends(CNDSSearchMetaDataViewModel, _super);
            function CNDSSearchMetaDataViewModel(CNDSSearchMetaDataDTO) {
                var _this = _super.call(this) || this;
                if (CNDSSearchMetaDataDTO == null) {
                    ...
                    _this.ChildMetadata = ko.observableArray();
                    _this.References = ko.observableArray();
                    _this.SelectedDisplay = ko.observable();
                }
                else {
                    _this.ID = ko.observable(CNDSSearchMetaDataDTO.ID);
                    _this.ParentDomainID = ko.observable(CNDSSearchMetaDataDTO.ParentDomainID);
                    _this.Title = ko.observable(CNDSSearchMetaDataDTO.Title);
                    _this.ChildMetadata = ko.observableArray(CNDSSearchMetaDataDTO.ChildMetadata == null ? null : CNDSSearchMetaDataDTO.ChildMetadata.map(function (item) { return new CNDSSearchMetaDataViewModel(item); }));
                    _this.References = ko.observableArray(CNDSSearchMetaDataDTO.References == null ? null : CNDSSearchMetaDataDTO.References.map(function (item) { return new DomainReferenceViewModel(item); }));
                    _this.SelectedDisplay = ko.observable(CNDSSearchMetaDataDTO.SelectedDisplay);
                }
                return _this;
            }
            CNDSSearchMetaDataViewModel.prototype.toData = function () {
                return {
                    ID: this.ID(),
                    ParentDomainID: this.ParentDomainID(),
                    Title: this.Title(),
            ...
            return CNDSSearchMetaDataViewModel;
        }(ViewModel));
        ViewModels.CNDSSearchMetaDataViewModel = CNDSSearchMetaDataViewModel;
        var CNDSUpdateDataMartPriorityAndDueDateViewModel = (function (_super) {
            __extends(CNDSUpdateDataMartPriorityAndDueDateViewModel, _super);
            function CNDSUpdateDataMartPriorityAndDueDateViewModel(CNDSUpdateDataMartPriorityAndDueDateDTO) {
                var _this = _super.call(this) || this;
                if (CNDSUpdateDataMartPriorityAndDueDateDTO == null) {
                    ...
                    _this.RequestDataMartID = ko.observable(CNDSUpdateDataMartPriorityAndDueDateDTO.RequestDataMartID);
                    _this.Priority = ko.observable(CNDSUpdateDataMartPriorityAndDueDateDTO.Priority);
                    _this.DueDate = ko.observable(CNDSUpdateDataMartPriorityAndDueDateDTO.DueDate);
                }
                return _this;
            }
            CNDSUpdateDataMartPriorityAndDueDateViewModel.prototype.toData = function () {
                return {
                    RequestDataMartID: this.RequestDataMartID(),
                    Priority: this.Priority(),
                    DueDate: this.DueDate(),
            ...
            return CNDSUpdateDataMartPriorityAndDueDateViewModel;
        }(ViewModel));
        ViewModels.CNDSUpdateDataMartPriorityAndDueDateViewModel = CNDSUpdateDataMartPriorityAndDueDateViewModel;
        var CNDSDomainSearchViewModel = (function (_super) {
            __extends(CNDSDomainSearchViewModel, _super);
            function CNDSDomainSearchViewModel(CNDSDomainSearchDTO) {
                var _this = _super.call(this) || this;
                if (CNDSDomainSearchDTO == null) {
                    ...
                    _this.DomainIDs = ko.observableArray(CNDSDomainSearchDTO.DomainIDs == null ? null : CNDSDomainSearchDTO.DomainIDs.map(function (item) { return item; }));
                    _this.DomainReferences = ko.observableArray(CNDSDomainSearchDTO.DomainReferences == null ? null : CNDSDomainSearchDTO.DomainReferences.map(function (item) { return item; }));
                }
                return _this;
            }
            CNDSDomainSearchViewModel.prototype.toData = function () {
                return {
                    DomainIDs: this.DomainIDs(),
                    DomainReferences: this.DomainReferences(),
                };
            };
            return CNDSDomainSearchViewModel;
        }(ViewModel));
        ViewModels.CNDSDomainSearchViewModel = CNDSDomainSearchViewModel;
        var CNDSNetworkProjectRequestTypeDataMartViewModel = (function (_super) {
            __extends(CNDSNetworkProjectRequestTypeDataMartViewModel, _super);
            function CNDSNetworkProjectRequestTypeDataMartViewModel(CNDSNetworkProjectRequestTypeDataMartDTO) {
                var _this = _super.call(this) || this;
                if (CNDSNetworkProjectRequestTypeDataMartDTO == null) {
                    _this.DefinitionID = ko.observable();
                    _this.NetworkID = ko.observable();
                    _this.Network = ko.observable();
                    _this.ProjectID = ko.observable();
                    _this.Project = ko.observable();
                    ...
                    _this.DefinitionID = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.DefinitionID);
                    _this.NetworkID = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.NetworkID);
                    _this.Network = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.Network);
                    _this.ProjectID = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.ProjectID);
                    _this.Project = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.Project);
                    _this.DataMartID = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.DataMartID);
                    _this.DataMart = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.DataMart);
                    _this.RequestTypeID = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.RequestTypeID);
                    _this.RequestType = ko.observable(CNDSNetworkProjectRequestTypeDataMartDTO.RequestType);
                }
                return _this;
            }
            CNDSNetworkProjectRequestTypeDataMartViewModel.prototype.toData = function () {
                return {
            ...
            return CNDSNetworkProjectRequestTypeDataMartViewModel;
        }(CNDSProjectRequestTypeDataMartViewModel));
        ViewModels.CNDSNetworkProjectRequestTypeDataMartViewModel = CNDSNetworkProjectRequestTypeDataMartViewModel;
        var CNDSUpdateAssignedPermissionViewModel = (function (_super) {
            __extends(CNDSUpdateAssignedPermissionViewModel, _super);
            function CNDSUpdateAssignedPermissionViewModel(CNDSUpdateAssignedPermissionDTO) {
                var _this = _super.call(this) || this;
                if (CNDSUpdateAssignedPermissionDTO == null) {
                    ...
                    _this.Delete = ko.observable(CNDSUpdateAssignedPermissionDTO.Delete);
                    _this.SecurityGroupID = ko.observable(CNDSUpdateAssignedPermissionDTO.SecurityGroupID);
                    _this.PermissionID = ko.observable(CNDSUpdateAssignedPermissionDTO.PermissionID);
                    _this.Allowed = ko.observable(CNDSUpdateAssignedPermissionDTO.Allowed);
                }
                return _this;
            }
            CNDSUpdateAssignedPermissionViewModel.prototype.toData = function () {
                return {
                    Delete: this.Delete(),
                    SecurityGroupID: this.SecurityGroupID(),
                    PermissionID: this.PermissionID(),
            ...
            return CNDSUpdateAssignedPermissionViewModel;
        }(CNDSAssignedPermissionViewModel));
        ViewModels.CNDSUpdateAssignedPermissionViewModel = CNDSUpdateAssignedPermissionViewModel;
        ...
        var CNDSNetworkRequestTypeDefinitionViewModel = (function (_super) {
            __extends(CNDSNetworkRequestTypeDefinitionViewModel, _super);
            function CNDSNetworkRequestTypeDefinitionViewModel(CNDSNetworkRequestTypeDefinitionDTO) {
                var _this = _super.call(this) || this;
                if (CNDSNetworkRequestTypeDefinitionDTO == null) {
                    ...
                    _this.NetworkID = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.NetworkID);
                    _this.Network = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.Network);
                    _this.ProjectID = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.ProjectID);
                    _this.Project = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.Project);
                    _this.RequestTypeID = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.RequestTypeID);
                    _this.RequestType = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.RequestType);
                    _this.DataSourceID = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.DataSourceID);
                    _this.DataSource = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.DataSource);
                    _this.ID = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.ID);
                    _this.Timestamp = ko.observable(CNDSNetworkRequestTypeDefinitionDTO.Timestamp);
                }
                return _this;
            }
            CNDSNetworkRequestTypeDefinitionViewModel.prototype.toData = function () {
                return {
                    NetworkID: this.NetworkID(),
                    Network: this.Network(),
                    ProjectID: this.ProjectID(),
            ...
            return CNDSNetworkRequestTypeDefinitionViewModel;
        }(EntityDtoWithIDViewModel));
        ViewModels.CNDSNetworkRequestTypeDefinitionViewModel = CNDSNetworkRequestTypeDefinitionViewModel;
        var CNDSNetworkRequestTypeMappingViewModel = (function (_super) {
            __extends(CNDSNetworkRequestTypeMappingViewModel, _super);
            function CNDSNetworkRequestTypeMappingViewModel(CNDSNetworkRequestTypeMappingDTO) {
                var _this = _super.call(this) || this;
                if (CNDSNetworkRequestTypeMappingDTO == null) {
                    ...
                    _this.NetworkID = ko.observable(CNDSNetworkRequestTypeMappingDTO.NetworkID);
                    _this.Network = ko.observable(CNDSNetworkRequestTypeMappingDTO.Network);
                    _this.ProjectID = ko.observable(CNDSNetworkRequestTypeMappingDTO.ProjectID);
                    _this.Project = ko.observable(CNDSNetworkRequestTypeMappingDTO.Project);
                    _this.RequestTypeID = ko.observable(CNDSNetworkRequestTypeMappingDTO.RequestTypeID);
                    _this.RequestType = ko.observable(CNDSNetworkRequestTypeMappingDTO.RequestType);
                    _this.Routes = ko.observableArray(CNDSNetworkRequestTypeMappingDTO.Routes == null ? null : CNDSNetworkRequestTypeMappingDTO.Routes.map(function (item) { return new CNDSNetworkRequestTypeDefinitionViewModel(item); }));
                    _this.ID = ko.observable(CNDSNetworkRequestTypeMappingDTO.ID);
                    _this.Timestamp = ko.observable(CNDSNetworkRequestTypeMappingDTO.Timestamp);
                }
                return _this;
            }
            CNDSNetworkRequestTypeMappingViewModel.prototype.toData = function () {
                return {
                    NetworkID: this.NetworkID(),
                    Network: this.Network(),
                    ProjectID: this.ProjectID(),
            ...
            return CNDSNetworkRequestTypeMappingViewModel;
        }(EntityDtoWithIDViewModel));
        ViewModels.CNDSNetworkRequestTypeMappingViewModel = CNDSNetworkRequestTypeMappingViewModel;
        ...
        var OrganizationViewModel = (function (_super) {
            ...
            function OrganizationViewModel(OrganizationDTO) {
                ...
                if (OrganizationDTO == null) {
                    ...
                    _this.Metadata = ko.observableArray(OrganizationDTO.Metadata == null ? null : OrganizationDTO.Metadata.map(function (item) { return new MetadataViewModel(item); }));
        ...
        var RequestViewModel = (function (_super) {
            ...
            function RequestViewModel(RequestDTO) {
                ...
                if (RequestDTO == null) {
                    ...
                    _this.IsProxyRequest = ko.observable();
                    _this.ID = ko.observable();
                    _this.Timestamp = ko.observable();
                }
                else {
                    ...
                    _this.IsProxyRequest = ko.observable(RequestDTO.IsProxyRequest);
        ...
        var UserViewModel = (function (_super) {
            ...
            function UserViewModel(UserDTO) {
                ...
                if (UserDTO == null) {
                    ...
                    _this.UserType = ko.observable(UserDTO.UserType);
                    _this.Metadata = ko.observableArray(UserDTO.Metadata == null ? null : UserDTO.Metadata.map(function (item) { return new MetadataViewModel(item); }));
        ...
        var DataMartViewModel = (function (_super) {
            ...
            function DataMartViewModel(DataMartDTO) {
                ...
                if (DataMartDTO == null) {
                    ...
                    _this.Metadata = ko.observableArray(DataMartDTO.Metadata == null ? null : DataMartDTO.Metadata.map(function (item) { return new MetadataViewModel(item); }));
        ...
        var UserWithSecurityDetailsViewModel = (function (_super) {
            ...
            function UserWithSecurityDetailsViewModel(UserWithSecurityDetailsDTO) {
                ...
                if (UserWithSecurityDetailsDTO == null) {
                    ...
                    _this.UserType = ko.observable(UserWithSecurityDetailsDTO.UserType);
                    _this.Metadata = ko.observableArray(UserWithSecurityDetailsDTO.Metadata == null ? null : UserWithSecurityDetailsDTO.Metadata.map(function (item) { return new MetadataViewModel(item); }));
