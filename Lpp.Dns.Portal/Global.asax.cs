...
namespace Lpp.Dns.Portal.Root
{
    ...
    {
        public static readonly string PMNVersionNumber;
        public static readonly string CNDSVersionNumber;

        static Global() {
            PMNVersionNumber = typeof(Global).Assembly.GetName().Version.ToString(4);
            CNDSVersionNumber = typeof(Lpp.CNDS.DTO.DomainDTO).Assembly.GetName().Version.ToString(2);
        }
