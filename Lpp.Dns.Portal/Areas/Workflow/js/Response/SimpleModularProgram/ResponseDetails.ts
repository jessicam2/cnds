...
module Workflow.SimpleModularProgram.ResponseDetail {
    var vm: ViewModel;
    ...
    export class ViewModel extends Global.WorkflowActivityViewModel {
        ...
        constructor(bindingControl: JQuery, routings: Dns.Interfaces.IRequestDataMartDTO[], responses: Dns.Interfaces.IResponseDTO[], documents: Dns.Interfaces.IExtendedDocumentDTO[], canViewPendingApprovalResponses: boolean) {
    ...
    $(() => {
        ...
        Dns.WebApi.Response.GetDetails(responseIDs).done((details) => {
            ...
            vm = new ViewModel(bindingControl, ss.RequestDataMarts, ss.Responses, ss.Documents, ss.CanViewPendingApprovalResponses);
