...
module Workflow.Response.WFDataChecker.ResponseDetails {
    ...
    export class ViewModel extends Global.WorkflowActivityViewModel {
        ...
        constructor(bindingControl: JQuery, requestID: any, routings: Dns.Interfaces.IRequestDataMartDTO[], responses: Dns.Interfaces.IResponseDTO[], documents: Dns.Interfaces.IExtendedDocumentDTO[], req: Dns.Interfaces.IRequestDTO, canViewPendingApprovalResponses: boolean) {
    ...
    $(() => {
        ...
        Dns.WebApi.Response.GetDetails(responseIDs).done((details) => {
            ...
            vm = new ViewModel(bindingControl, rootVM.Request.ID(), ss.RequestDataMarts, ss.Responses, ss.Documents, rootVM.Request.toData(), ss.CanViewPendingApprovalResponses);
