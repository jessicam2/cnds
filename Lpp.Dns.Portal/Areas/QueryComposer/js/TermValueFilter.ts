module Plugins.Requests.QueryBuilder.MDQ {
    ...
    export class TermValueFilter {       
        ...
        public AgeRangeStratifications(): Dns.Structures.KeyValuePair[] {
            ...
            var translations = [];
            if (this._containsSummaryTables()) {
                TermValueFilter.GetTranslations<Dns.Enums.AgeStratifications>(Dns.Enums.AgeStratificationsTranslation, [Dns.Enums.AgeStratifications.Ten, Dns.Enums.AgeStratifications.Seven, Dns.Enums.AgeStratifications.Four, Dns.Enums.AgeStratifications.Two]).forEach((i) => translations.push(i));
            }
