...
module Plugins.Requests.QueryBuilder.MDQ {
    ...
    export class ViewModel extends Global.PageViewModel {
        ...
        public SexForCritieria: Dns.Structures.KeyValuePair[];
        public SettingForCritieria: Dns.Structures.KeyValuePair[];
        public RaceEthnicityForCritieria: Dns.Structures.KeyValuePair[];
        public AgeGroupForStratification: Dns.Structures.KeyValuePair[];
        ...
        constructor(options: ViewModelOptions) {
            ...
            this.SexForCritieria = termValueFilter.SexValues();
            this.SettingForCritieria = termValueFilter.SettingsValues();
            this.RaceEthnicityForCritieria = termValueFilter.RaceEthnicityValues();
            this.AgeGroupForStratification = termValueFilter.AgeRangeStratifications();
