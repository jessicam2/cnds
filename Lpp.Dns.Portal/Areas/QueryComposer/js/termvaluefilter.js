            ...
            (function (MDQ) {
                ...
                var TermValueFilter = (function () {
                    ...
                    TermValueFilter.prototype.AgeRangeStratifications = function () {
                        ...
                        var translations = [];
                        if (this._containsSummaryTables()) {
                            TermValueFilter.GetTranslations(Dns.Enums.AgeStratificationsTranslation, [Dns.Enums.AgeStratifications.Ten, Dns.Enums.AgeStratifications.Seven, Dns.Enums.AgeStratifications.Four, Dns.Enums.AgeStratifications.Two]).forEach(function (i) { return translations.push(i); });
                        }
