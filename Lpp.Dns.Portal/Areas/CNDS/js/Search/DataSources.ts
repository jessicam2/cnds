...
module CNDS.Search.DataSources_NoQlik {
    var vm: ViewModel;
    ...
    export class ViewModel extends Global.PageViewModel {
        ...
        public TriggerDataSourceSearch() {
            let self = this;
            var ids: Dns.Interfaces.ICNDSDomainSearchDTO = { DomainIDs: [], DomainReferences: [] };
            ...
            Dns.WebApi.CNDSSearch.DataSourcesSearch(ids).done((results) => {
    ...
    function init() {
        Dns.WebApi.CNDSSearch.DataSourcesDomains().done((domains) => {
            $(() => {
