...
module RequestType.Details {
    ...
    export class ViewModel extends Global.PageViewModel {
            ...
            )
        {
            ...
            //This is only for PMNDEV-5931 and should only remain in the 6.0 branch.  This workflow is not complete in 6.0 and should never be used.  
           
            var filterworkflows = workflows.filter(function (el) {                
                return el.ID.toUpperCase() !== "E9656288-33FF-4D1F-BA77-C82EB0BF0192";
            });
            self.Workflows = filterworkflows;
    ...
    function init() {
        ...
        $.when<any>(
            ...
            id == null ? null : Dns.WebApi.RequestTypes.GetPermissions([id], [Permissions.RequestTypes.Delete, Permissions.RequestTypes.Edit, Permissions.RequestTypes.ManageSecurity]),
                ...
                $.when<Dns.Interfaces.ITemplateDTO[]>(
                    ...
                    $(() => {
                        ...
                        vm = new ViewModel(
                            ...
                            requestTypeTerms || [],
                            bindingControl,
                            screenPermissions || [Permissions.RequestTypes.Delete,
                            Permissions.RequestTypes.Edit,
                            Permissions.RequestTypes.ManageSecurity],
                            permissionList || [],
