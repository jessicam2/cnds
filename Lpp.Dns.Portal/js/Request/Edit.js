    ...
    (function (Edit) {
        ...
        var RequestDetailsViewModel = (function (_super) {
            ...
            RequestDetailsViewModel.prototype.onSelectProject = function () {
                var _this = this;
                Global.Helpers.ShowDialog("Select Project", "/request/selectproject", ["Close"], 550, 400, { Projects: Edit.RawModel.Projects }).done(function (result) {
                    if (!result)
                        return;
        ...
        Edit.init = init;
    })(Edit = PMNRequest.Edit || (PMNRequest.Edit = {}));
})(PMNRequest || (PMNRequest = {}));
