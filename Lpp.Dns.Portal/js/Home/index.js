    ...
    (function (Index) {
        ...
        var ViewModel = (function (_super) {
            ...
            function ViewModel(projects, gRequestsSetting, gTasksSetting, gNotificationsSetting, gMessagesSetting, gDataMartsSetting, gDataMartsRoutesSetting, bindingControl) {
                ...
                _this.firstLoadNotifications = true;
                _this.firstLoadRequests = true;
                _this.firstLoadMessages = true;
                _this.firstLoadTasks = true;
                ...
                _this.dsNotifications = new kendo.data.DataSource({
                    ...
                    change: function (e) {
                        if (_this.firstLoadNotifications) {
                            _this.firstLoadNotifications = false;
                            vm.gNotificationsVisible(e.items != null && e.items.length > 0);
                            vm.gNotificationsHeight(e.items != null && e.items.length > 0 ? "200px" : null);
                        }
                    }
                });
                ...
                _this.dsRequest = new kendo.data.DataSource({
                    ...
                    change: function (e) {
                        if (_this.firstLoadRequests) {
                            _this.firstLoadRequests = false;
                            vm.gRequestsHeight(e.items != null && e.items.length > 0 ? "600px" : null);
                        }
                    }
                });
                ...
                _this.dsMessages = new kendo.data.DataSource({
                    ...
                    change: function (e) {
                        if (_this.firstLoadMessages) {
                            _this.firstLoadMessages = false;
                            vm.gMessagesHeight(e.items != null && e.items.length > 0 ? "200px" : null);
                        }
                    }
                });
                ...
                _this.dsTasks = new kendo.data.DataSource({
                    ...
                    change: function (e) {
                        if (_this.firstLoadTasks) {
                            _this.firstLoadTasks = false;
                            vm.gTasksHeight(e.items != null && e.items.length > 0 ? "300px" : null);
                        }
                    }
                });
