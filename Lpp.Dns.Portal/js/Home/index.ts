...
module Home.Index {
    ...
    export class ViewModel extends Global.PageViewModel {
        ...
        private firstLoadNotifications: boolean = true;
        private firstLoadRequests: boolean = true;
        private firstLoadMessages: boolean = true;
        private firstLoadTasks: boolean = true;
        ...
        constructor(projects: Dns.Interfaces.IProjectDTO[], gRequestsSetting: string, gTasksSetting: string, gNotificationsSetting: string, gMessagesSetting: string, gDataMartsSetting: string, gDataMartsRoutesSetting: string, bindingControl: JQuery) {
            ...
            this.dsNotifications = new kendo.data.DataSource({
                ...
                change: (e) => {
                    if (this.firstLoadNotifications) {
                        this.firstLoadNotifications = false;
            ...
            this.dsRequest = new kendo.data.DataSource({
                ...
                change: (e) => {
                    if (this.firstLoadRequests) {
                        this.firstLoadRequests = false;
            ...
            this.dsTasks = new kendo.data.DataSource({
                ...
                change: (e) => {
                    if (this.firstLoadTasks)
                    {
                        this.firstLoadTasks = false;
