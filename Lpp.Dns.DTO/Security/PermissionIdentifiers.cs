...
namespace Lpp.Dns.DTO.Security
{
    ...
    public static class PermissionIdentifiers
    {
        ...
        public static class Organization
        {
            ...
            /// <summary>
            /// Can Manage Metadata Visibility
            /// </summary>
            public static readonly PermissionDefinition ManageCNDSVisibility = new PermissionDefinition
            {
                ID = new Guid("0D2FD719-B3A9-40FF-9C3A-EFE13FE485A0"),
                Locations = new PermissionAclTypes[] { PermissionAclTypes.Global, PermissionAclTypes.Organizations, PermissionAclTypes.Users, PermissionAclTypes.DataMarts }
            };
        ...
        public static class Portal
        {
            ...
            /// Can Search CNDS
            /// </summary>
            public static readonly PermissionDefinition SearchCNDS = new PermissionDefinition
            {
                ID = new Guid("B76D3582-2D61-4847-9CA1-6C72DFD798AB"),
                Locations = new PermissionAclTypes[] { PermissionAclTypes.Global }
            };
            /// <summary>
            /// Can Manage Metadata Visibility
