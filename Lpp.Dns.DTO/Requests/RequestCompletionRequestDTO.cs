...
namespace Lpp.Dns.DTO
{
    ...
    /// </summary>
    [DataContract]
    public class CreateCNDSRequestDetailsDTO : ICompletionRequest<RequestDTO> {
        /// <summary>
        /// Gets or sets the ID of Demand Activity result
        /// </summary>
        [DataMember]
        ...
        public RequestDTO Dto { get; set; }
        /// <summary>
        /// The routes to register with the request.
        /// </summary>
        [DataMember]
        public IEnumerable<CNDSNetworkProjectRequestTypeDataMartDTO> Routes { get; set; }
        /// <summary>
        /// Data
        /// </summary>
        [DataMember]
