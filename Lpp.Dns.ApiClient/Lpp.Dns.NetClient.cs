...
namespace Lpp.Dns.ApiClient
{
	 public class DnsClient : HttpClientEx
	 {
        ...
        public Comments Comments
	 	...
	 	CNDSMetadata _CNDSMetadata = null;
        public CNDSMetadata CNDSMetadata
                            {
                                get {
                                    if (_CNDSMetadata == null)
                                        _CNDSMetadata = new CNDSMetadata(this);

                                    return _CNDSMetadata;
                                }
                            }
	 	CNDSNetworks _CNDSNetworks = null;
        public CNDSNetworks CNDSNetworks
                            {
                                get {
                                    if (_CNDSNetworks == null)
                                        _CNDSNetworks = new CNDSNetworks(this);

                                    return _CNDSNetworks;
                                }
                            }
	 	CNDSRequests _CNDSRequests = null;
        public CNDSRequests CNDSRequests
                            {
                                get {
                                    if (_CNDSRequests == null)
                                        _CNDSRequests = new CNDSRequests(this);

                                    return _CNDSRequests;
                                }
                            }
	 	CNDSRequestTypes _CNDSRequestTypes = null;
        public CNDSRequestTypes CNDSRequestTypes
                            {
                                get {
                                    if (_CNDSRequestTypes == null)
                                        _CNDSRequestTypes = new CNDSRequestTypes(this);

                                    return _CNDSRequestTypes;
                                }
                            }
	 	CNDSSearch _CNDSSearch = null;
        public CNDSSearch CNDSSearch
                            {
                                get {
                                    if (_CNDSSearch == null)
                                        _CNDSSearch = new CNDSSearch(this);

                                    return _CNDSSearch;
                                }
                            }
	 	CNDSSecurity _CNDSSecurity = null;
        public CNDSSecurity CNDSSecurity
                            {
                                get {
                                    if (_CNDSSecurity == null)
                                        _CNDSSecurity = new CNDSSecurity(this);

                                    return _CNDSSecurity;
                                }
                            }
	 }
	 ...
	 public class Users : HttpClientDataEndpoint<DnsClient, UserDTO>
	 {
	 	 ...
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO>> GetAvailableUserMetadata(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.MetadataDTO>(Path + "/GetAvailableUserMetadata", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 ...
	 	 public async Task UpdateUserVisibility(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO> userMetadata)
	 	 {
	 	 	 var result = await Client.Post(Path + "/UpdateUserVisibility", userMetadata);
	 	 	 return;
	 	 }
	 }
	 public class Theme
	 ...
	 public class Organizations : HttpClientDataEndpoint<DnsClient, OrganizationDTO>
	 {
	 	 ...
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO>> GetAvailableOrganizationMetadata(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.MetadataDTO>(Path + "/GetAvailableOrganizationMetadata", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.OrganizationDTO>> GetForUser(System.Guid userID, string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.OrganizationDTO>(Path + "/GetForUser?userID=" + System.Net.WebUtility.UrlEncode(userID.ToString()) + "&", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 ...
	 	 public async Task UpdateOrganizationVisibility(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO> orgMetadata)
	 	 {
	 	 	 var result = await Client.Post(Path + "/UpdateOrganizationVisibility", orgMetadata);
	 	 	 return;
	 	 }
	 }
	 ...
	 public class DataMarts : HttpClientDataEndpoint<DnsClient, DataMartDTO>
	 {
	 	 ...
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO>> GetAvailableDataMartMetadata(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.MetadataDTO>(Path + "/GetAvailableDataMartMetadata", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 ...
	 	 public async Task UpdateDataMartVisibility(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO> dmMetadata)
	 	 {
	 	 	 var result = await Client.Post(Path + "/UpdateDataMartVisibility", dmMetadata);
	 	 	 return;
	 	 }
	 }
	 ...
	 public class Requests
	 {
	 	 ...
	 	 public async Task<Lpp.Dns.DTO.RequestCompletionResponseDTO> CreateRequest(Lpp.Dns.DTO.CreateCNDSRequestDetailsDTO details)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CreateCNDSRequestDetailsDTO, Lpp.Dns.DTO.RequestCompletionResponseDTO>(Path + "/CreateRequest", details);
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 ...
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.DataMartListDTO>> GetExternalRoutesForRequest(System.Guid requestID, string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.DataMartListDTO>(Path + "/GetExternalRoutesForRequest?requestID=" + System.Net.WebUtility.UrlEncode(requestID.ToString()) + "&", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 ...
	 public class Documents
	 {
	 	 ...
	 	 public async Task<System.Net.Http.HttpResponseMessage> UploadResponseOutput()
	 	 {
	 	 	 var result = await Client.Post(Path + "/UploadResponseOutput");
	 	 	 return result;
	 	 }
	 ...
	 public class CNDSMetadata
	 {
	 	 readonly DnsClient Client;
	 	 readonly string Path;
	 	 public CNDSMetadata(DnsClient client)
	 	 {
	 	 	 this.Client = client;
	 	 	 this.Path = "/CNDSMetadata";
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO>> ListDomains(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.MetadataDTO>(Path + "/ListDomains", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO>> InsertOrUpdateDomains(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO> metaData)
	 	 {
	 	 	 var result = await Client.Post<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.MetadataDTO>, Lpp.Dns.DTO.MetadataDTO>(Path + "/InsertOrUpdateDomains", metaData);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.DomainDTO>> GetForOrganization(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDS.DomainDTO>(Path + "/GetForOrganization", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task InsertorUpdateDataDomains(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSMetadata.DomainUseReturnDTO> domainUses)
	 	 {
	 	 	 var result = await Client.Post(Path + "/InsertorUpdateDataDomains", domainUses);
	 	 	 return;
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.DomainDTO>> GetForDataMarts(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDS.DomainDTO>(Path + "/GetForDataMarts", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.DomainDTO>> GetForUsers(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDS.DomainDTO>(Path + "/GetForUsers", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 }
	 public class CNDSNetworks
	 {
	 	 readonly DnsClient Client;
	 	 readonly string Path;
	 	 public CNDSNetworks(DnsClient client)
	 	 {
	 	 	 this.Client = client;
	 	 	 this.Path = "/CNDSNetworks";
	 	 }
	 	 public async Task<System.Linq.IQueryable<Lpp.Dns.DTO.CNDSNetworkDTO>> List(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSNetworkDTO>(Path + "/List", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<Lpp.Dns.DTO.CNDSNetworkDTO> Register(Lpp.Dns.DTO.CNDSNetworkDTO dto)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDSNetworkDTO, Lpp.Dns.DTO.CNDSNetworkDTO>(Path + "/Register", dto);
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> Update(Lpp.Dns.DTO.CNDSNetworkDTO dto)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDSNetworkDTO>(Path + "/Update", dto);
	 	 	 return result;
	 	 }
	 ...
	 public class CNDSRequests
	 {
	 	 readonly DnsClient Client;
	 	 readonly string Path;
	 	 public CNDSRequests(DnsClient client)
	 	 {
	 	 	 this.Client = client;
	 	 	 this.Path = "/CNDSRequests";
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> Register(Lpp.Dns.DTO.CNDSRegisterRequestDTO dto)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDSRegisterRequestDTO>(Path + "/Register", dto);
	 	 	 return result;
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> UpdateRoutingStatus(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSUpdateRoutingStatusDTO> dtos)
	 	 {
	 	 	 var result = await Client.Post<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSUpdateRoutingStatusDTO>>(Path + "/UpdateRoutingStatus", dtos);
	 	 	 return result;
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> UpdatePriorityAndDueDate(Lpp.Dns.DTO.CNDS.CNDSUpdateDataMartPriorityAndDueDateDTO dto)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDS.CNDSUpdateDataMartPriorityAndDueDateDTO>(Path + "/UpdatePriorityAndDueDate", dto);
	 	 	 return result;
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> ResubmitRoute(Lpp.Dns.DTO.CNDSResubmitRouteDTO dto)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDSResubmitRouteDTO>(Path + "/ResubmitRoute", dto);
	 	 	 return result;
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> TerminateRoute(System.Guid id)
	 	 {
	 	 	 var result = await Client.Post<System.Guid>(Path + "/TerminateRoute", id);
	 	 	 return result;
	 	 }
	 	 public async Task<System.Net.Http.HttpResponseMessage> TerminateRequest(System.Guid id)
	 	 {
	 	 	 var result = await Client.Post<System.Guid>(Path + "/TerminateRequest", id);
	 	 	 return result;
	 	 }
	 }
	 public class CNDSRequestTypes
	 {
	 	 readonly DnsClient Client;
	 	 readonly string Path;
	 	 public CNDSRequestTypes(DnsClient client)
	 	 {
	 	 	 this.Client = client;
	 	 	 this.Path = "/CNDSRequestTypes";
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSProjectRequestTypeDataMartDTO>> ListAvailableRequestTypes(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSProjectRequestTypeDataMartDTO>(Path + "/ListAvailableRequestTypes", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSMappingItemDTO>> ListAvailableNetworkRoutes(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSMappingItemDTO>(Path + "/ListAvailableNetworkRoutes", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO>> ValidateNetworkRequestTypeMappings(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO> dtos)
	 	 {
	 	 	 var result = await Client.Post<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO>, Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO>(Path + "/ValidateNetworkRequestTypeMappings", dtos);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task CreateNetworkRequestTypeMapping(Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO dto)
	 	 {
	 	 	 var result = await Client.Post(Path + "/CreateNetworkRequestTypeMapping", dto);
	 	 	 return;
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO>> ListMappings(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO>(Path + "/ListMappings", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO> GetNetworkRequestTypeMapping(System.Guid id)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSNetworkRequestTypeMappingDTO>(Path + "/GetNetworkRequestTypeMapping?id=" + System.Net.WebUtility.UrlEncode(id.ToString()) + "&");
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 public async Task DeleteMapping(System.Collections.Generic.IEnumerable<System.Guid> mappingID)
	 	 {
	 	 ...
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>> ListNetworkRequestTypeDefinitions(string oDataQuery = null)
	 	 {
	 	 	 ...
	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>(Path + "/ListNetworkRequestTypeDefinitions", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO> GetNetworkRequestTypeDefinition(System.Guid id)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>(Path + "/GetNetworkRequestTypeDefinition?id=" + System.Net.WebUtility.UrlEncode(id.ToString()) + "&");
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>> ValidateNetworkRequestTypeDefinition(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO> dtos)
	 	 {
	 	 	 var result = await Client.Post<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>, Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>(Path + "/ValidateNetworkRequestTypeDefinition", dtos);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>> CreateOrUpdateNetworkRequestTypeDefinition(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO> dtos)
	 	 {
	 	 	 var result = await Client.Post<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>, Lpp.Dns.DTO.CNDSNetworkRequestTypeDefinitionDTO>(Path + "/CreateOrUpdateNetworkRequestTypeDefinition", dtos);
	 	 	 return result.ReturnList();
	 	 }
	 ...
	 public class CNDSSearch
	 {
	 	 readonly DnsClient Client;
	 	 readonly string Path;
	 	 public CNDSSearch(DnsClient client)
	 	 {
	 	 	 this.Client = client;
	 	 	 this.Path = "/CNDSSearch";
	 	 }
	 	 public async Task<System.Linq.IQueryable<Lpp.Dns.DTO.CNDSDataSourceExtendedDTO>> DataSources(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSDataSourceExtendedDTO>(Path + "/DataSources", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.CNDSSearchMetaDataDTO>> DataSourcesDomains(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDS.CNDSSearchMetaDataDTO>(Path + "/DataSourcesDomains", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.CNDSDataSourceSearchDTO>> DataSourcesSearch(Lpp.Dns.DTO.CNDS.CNDSDomainSearchDTO ids)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDS.CNDSDomainSearchDTO, Lpp.Dns.DTO.CNDS.CNDSDataSourceSearchDTO>(Path + "/DataSourcesSearch", ids);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.CNDSSearchMetaDataDTO>> OrganizationsDomains(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDS.CNDSSearchMetaDataDTO>(Path + "/OrganizationsDomains", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDS.CNDSOrganizationSearchDTO>> OrganizationsSearch(Lpp.Dns.DTO.CNDS.CNDSDomainSearchDTO ids)
	 	 {
	 	 	 var result = await Client.Post<Lpp.Dns.DTO.CNDS.CNDSDomainSearchDTO, Lpp.Dns.DTO.CNDS.CNDSOrganizationSearchDTO>(Path + "/OrganizationsSearch", ids);
	 	 	 return result.ReturnList();
	 	 }
	 }
	 public class CNDSSecurity
	 {
	 	 readonly DnsClient Client;
	 	 readonly string Path;
	 	 public CNDSSecurity(DnsClient client)
	 	 {
	 	 	 this.Client = client;
	 	 	 this.Path = "/CNDSSecurity";
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSSecurityGroupDTO>> SecurityGroupList(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSSecurityGroupDTO>(Path + "/SecurityGroupList", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<Lpp.Dns.DTO.CNDSSecurityGroupDTO> SecurityGroupGet(System.Guid securityGroupID)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSSecurityGroupDTO>(Path + "/SecurityGroupGet?securityGroupID=" + System.Net.WebUtility.UrlEncode(securityGroupID.ToString()) + "&");
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 public async Task InsertOrUpdateSecurityGroups(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSSecurityGroupDTO> dtos)
	 	 {
	 	 	 var result = await Client.Post(Path + "/InsertOrUpdateSecurityGroups", dtos);
	 	 	 return;
	 	 }
	 	 public async Task SecurityGroupDelete(System.Collections.Generic.IEnumerable<System.Guid> ids)
	 	 {
	 	 	 await Client.Delete(Path + "/SecurityGroupDelete", ids);
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSSecurityGroupUserDTO>> SecurityGroupUsersList(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSSecurityGroupUserDTO>(Path + "/SecurityGroupUsersList", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<Lpp.Dns.DTO.CNDSSecurityGroupUserDTO> GetUserSecurityGroups(System.Guid userID)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSSecurityGroupUserDTO>(Path + "/GetUserSecurityGroups?userID=" + System.Net.WebUtility.UrlEncode(userID.ToString()) + "&");
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 public async Task SecurityGroupUsersUpdate(Lpp.Dns.DTO.CNDSSecurityGroupUserDTO dto)
	 	 {
	 	 	 var result = await Client.Post(Path + "/SecurityGroupUsersUpdate", dto);
	 	 	 return;
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSPermissionsDTO>> ListPermissions(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSPermissionsDTO>(Path + "/ListPermissions", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Boolean> HasPermissions(System.Guid permissionID, System.Guid userID)
	 	 {

	 	 	 var result = await Client.Get<System.Boolean>(Path + "/HasPermissions?permissionID=" + System.Net.WebUtility.UrlEncode(permissionID.ToString()) + "&userID=" + System.Net.WebUtility.UrlEncode(userID.ToString()) + "&");
	 	 	 return result.ReturnSingleItem();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSAssignedPermissionDTO>> GetSecurityGroupPermissions(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSAssignedPermissionDTO>(Path + "/GetSecurityGroupPermissions", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSAssignedPermissionDTO>> GetCurrentUserPermissions(string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSAssignedPermissionDTO>(Path + "/GetCurrentUserPermissions", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task<System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSAssignedPermissionDTO>> GetUserPermissions(System.Guid userID, string oDataQuery = null)
	 	 {

	 	 	 var result = await Client.Get<Lpp.Dns.DTO.CNDSAssignedPermissionDTO>(Path + "/GetUserPermissions?userID=" + System.Net.WebUtility.UrlEncode(userID.ToString()) + "&", oDataQuery);
	 	 	 return result.ReturnList();
	 	 }
	 	 public async Task SetPermissions(System.Collections.Generic.IEnumerable<Lpp.Dns.DTO.CNDSUpdateAssignedPermissionDTO> permissions)
	 	 {
