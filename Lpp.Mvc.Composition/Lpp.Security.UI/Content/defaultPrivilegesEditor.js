        ...
        return function (viewId) {
            ...
            var bind = function (own, inherited) {
                ...
                $.each(own || {}, function (privilegeId, allow) {
                    return bindOne(privilegeId, allow, true, function (row) { return row.inherited.hide(); });
                });
            };
            bind = gate(function () { return !!_view; }, bind);
            $(function () {
                _view = $(viewId);
                ...
                _view.find("a.Inherited").click(function () {
                    ...
                    var close = function (e) {
                        ...
                        inheritanceResetBox.fadeOut(100, function () { return inheritanceResetBox.appendTo(oldParent); });
            ...
            var editor = {
                ...
                onChange: function (f) { return $(editor).bind("change", f); }
            };
            return editor;
        };
    };
