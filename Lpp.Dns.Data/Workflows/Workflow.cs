...
namespace Lpp.Dns.Data
{
    ...
    public class Workflow : EntityWithID, IDbWorkflow
    {
        ...
        public Guid? RequestReviewWorkflowActivityID { get; set; }
        public virtual WorkflowActivity RequestReviewWorkflowActivity { get; set; }
        public Guid? CompleteDistributionWorkflowActivityID { get; set; }
        public virtual WorkflowActivity CompleteDistributionWorkflowActivity { get; set; }
