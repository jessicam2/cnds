...
namespace Lpp.Dns.DataMart.Model.QueryComposer.Adapters.TermProviders
{
    ...
    public class ModularProgram : IModelTermProvider
    {
        ...
        {
            get { return ModelTermsFactory.Terms.Where(t => t.ID == ModelTermsFactory.ModularProgramID || t.ID == ModelTermsFactory.SqlDistributionID || t.ID == ModelTermsFactory.FileUploadID).ToArray(); }
        }
    }
}
